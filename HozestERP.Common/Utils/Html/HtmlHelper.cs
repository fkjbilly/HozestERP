...
namespace HozestERP.Common.Utils.Html
{
    ...
    public partial class HtmlHelper
    {
        ...
        public static string NoHTML(string Htmlstring)
        {
            ...
            Htmlstring = Regex.Replace(Htmlstring, @"<([^pbul].[^>]*[^pbul])>", "", RegexOptions.IgnoreCase);

            Htmlstring = Regex.Replace(Htmlstring, @"</[^pbul]*?>", "", RegexOptions.IgnoreCase);
            ...
            Htmlstring = Regex.Replace(Htmlstring, @"<li>", "<br>", RegexOptions.IgnoreCase);
