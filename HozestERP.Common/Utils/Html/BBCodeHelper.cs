...
using HozestERP.Common.Utils.Html.CodeFormatter;
...
namespace HozestERP.Common.Utils.Html
{
    ...
    public partial class BBCodeHelper
    {
        ...
        public static string FormatURL(string text, string storeLocation)
        {

            // format the url tags: [url=http://www.nopCommerce.com]my site[/url]
            // becomes: <a href="http://www.nopCommerce.com">my site</a>
            text = regexUrl1.Replace(text, "<a href=\"" + storeLocation + "$1\" rel=\"nofollow\">$2</a>");

            // format the url tags: [url]http://www.nopCommerce.com[/url]
            // becomes: <a href="http://www.nopCommerce.com">http://www.nopCommerce.com</a>
            text = regexUrl2.Replace(text, "<a href=\"" + storeLocation + "$1\" rel=\"nofollow\">$1</a>");
