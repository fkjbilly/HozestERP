<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Root.Master"
    CodeBehind="ManagementFeeStatistics.aspx.cs" Inherits="HozestERP.Web.ManageBusiness.ManagementFeeStatistics" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function dataBind(DateType) {
            ...
            var DepartmentType = document.getElementById("<%=ddlDepartmentType.ClientID %>").value;
            var Project = document.getElementById("<%=ddlProject.ClientID %>").value;
            jQuery(function ($) {
                $.ajax({ url: "managementFeeStatistics.ashx?action=managementFeeStatistics&DateType=" + DateType + "&Year=" + Year + "&Month=" + Month + "&DepartmentType=" + DepartmentType,
                    type: "GET",
                    dataType: "json",
        ...
        <ContentTemplate>
            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                ...
                <tr>
                    ...
                    <td style="width: 200px;" align="left">
                        <asp:DropDownList ID="ddlProject" runat="server" Width="100%">
                        </asp:DropDownList>
                    </td>
