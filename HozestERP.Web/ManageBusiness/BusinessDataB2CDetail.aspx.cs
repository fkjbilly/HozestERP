...
{
    public partial class BusinessDataB2CDetail : BaseAdministrationPage, IEditPage
    {
        ...
        public void loadDate()
        {
            ...
            if (Id != 0 && Type == 0)
            {
                ...
                this.grdvClients.Columns[13].Visible = false;//操作列屏蔽
            }
            if (Id != 0)
            {
                BindGrid();
            ...
            if (Id == 0 && Type == 0)
            {
                this.txtDepartmentName.Text = "B2C服务部";
        ...
        protected void grdvClients_RowDataBound(object sender, GridViewRowEventArgs e)
        {
                 ...
                 e.Row.RowState == (DataControlRowState.Alternate | DataControlRowState.Edit))
            {
                ...
                var BusinessTypeList = base.CodeService.GetCodeListInfoByCodeTypeID(217);
                ...
                ddlBusinessType.Items.Add(new ListItem(" ", "0"));

                //B2C业务类型
                DropDownList ddlB2CBusinessType = (DropDownList)e.Row.FindControl("ddlB2CBusinessType");
                ddlB2CBusinessType.Items.Clear();
                var B2CBusinessTypeList = base.CodeService.GetCodeListInfoByCodeTypeID(221);
                ddlB2CBusinessType.DataSource = B2CBusinessTypeList;
                ddlB2CBusinessType.DataTextField = "CodeName";
                ddlB2CBusinessType.DataValueField = "CodeID";
                ddlB2CBusinessType.DataBind();
            }
        }
        ...
        protected void grdvClients_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            if (Info != null)
            {
                ...
                //B2C业务类型
                DropDownList ddlB2CBusinessType = (DropDownList)row.FindControl("ddlB2CBusinessType");
                ddlB2CBusinessType.Items.Clear();
                var B2CBusinessTypeList = base.CodeService.GetCodeListInfoByCodeTypeID(221);
                ddlB2CBusinessType.DataSource = B2CBusinessTypeList;
                ddlB2CBusinessType.DataTextField = "CodeName";
                ...
                ddlB2CBusinessType.SelectedValue = Info.B2CBusinessType.ToString();
        ...
        protected void grdvClients_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            var B2CBusinessType = row.FindControl("ddlB2CBusinessType") as DropDownList;
            ...
            if (ID == 0)
            {
                ...
                Info.B2CBusinessType = int.Parse(B2CBusinessType.SelectedValue);
