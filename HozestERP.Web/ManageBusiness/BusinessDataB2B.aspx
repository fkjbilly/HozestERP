...
CodeBehind="BusinessDataB2B.aspx.cs" Inherits="HozestERP.Web.ManageBusiness.BusinessDataB2B" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="提交时间"  SortExpression="StrSubmitDate">
        ...
        <asp:TemplateField HeaderText="操作"> 
            ...
            <ItemTemplate>
                <asp:ImageButton ID="imgBtnEdit" runat="server" ImageUrl="~/App_Themes/Default/Image/update.gif"
                        ToolTip="编辑" CommandName="Edit" CausesValidation="False" Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2B.Edit %>" />
                ...
                <asp:ImageButton ID="imgBtnDelete" runat="server" ImageUrl="~/App_Themes/Default/Image/close02.gif" CommandArgument='<%#Eval("ID")%>'
                        ...
                        Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2B.Delete %>" />
            </ItemTemplate>
        </asp:TemplateField>
       ...
       <tr>
            ...
            <td> 
                <asp:Button ID="btnAdd" SkinID="button4"  runat="server" Text="新增"  
                     Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2B.Add %>"  />
            </td>
            ...
            <td> 
                <asp:Button ID="btnDelete" runat="server" SkinID="button4" Text="批量删除" 
                 Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2B.AllDelete %>" 
