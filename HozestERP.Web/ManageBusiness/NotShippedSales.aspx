<%@ Page Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true"
    CodeBehind="NotShippedSales.aspx.cs" Inherits="HozestERP.Web.ManageBusiness.NotShippedSales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ProjectIdChange(nickId) {
            ...
            NickList.innerHTML = "";
            jQuery(function ($) {
                $.ajax({ url: "notShippedSales.ashx?ProjectId=" + ProjectId.value,
                    type: "GET",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
        ...
        //            jQuery(function ($) {
        //                $.ajax({ url: "notShippedSales.ashx?Warehouse=" + Warehouse.value,
        //                    type: "GET",
        //                    dataType: "json",
        //                    contentType: "application/json; charset=utf-8",
            ...
            jQuery(function ($) {
                $.ajax({ url: "notShippedSales.ashx",
                    ...
                    success: function (json) {
                        ...
                        var opt = HighChart.ChartOptionTemplates.Pie_Count(data, '', "未发货销量统计-总计" + total + "件");
                        var container = $("#Div");
            ...
            <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
                <tr>
                    ...
                    <td style="width: 120px">
                        <input id="txtPayBegin" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"
                    ...
                    <td style="width: 120px">
                        <input id="txtPayEnd" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate"
                            runat="server" style="width: 100%;" />
                    </td>
                    <td style="width: 40px">
                    </td>
