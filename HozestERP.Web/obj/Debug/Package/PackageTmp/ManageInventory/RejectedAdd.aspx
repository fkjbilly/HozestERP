<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" CodeBehind="RejectedAdd.aspx.cs" Inherits="HozestERP.Web.ManageInventory.RejectedAdd" %>
    ...
    <table class="detailTable" width="100%" border="0" cellspacing="0" cellpadding="3">
        <tbody>
            <tr>
                ...
                <td style="width: 140px" align="right">
                    采购单号<font color="red">*</font>:
                </td>
                <td style="width: 218px; border-right: 1px soild red;">
                    <asp:Literal ID="lblPurchaseCode" runat="server"></asp:Literal>
                </td>
            </tr>
            <tr>
                <td style="width: 140px" align="right">
...
<asp:Content ID="Content3" ContentPlaceHolderID="Contentplaceholder2" runat="server">
        ...
        <tr>
            <td>
                <asp:Button ID="btnSave" runat="server" Text="保存" ValidationGroup="ClientValidationGroup"
                    Visible="<% $CRMIsActionAllowed:ManageInventory.RejectedAdd.Save %>" OnClick="btnSave_Click"
    ...
    <script type="text/javascript">
        ...
        //更改退货状态
        $(document).on("click", "#imgReturn", function () {
            var Id = $(this).prev().val();
            var billStatus = "";
            $.ajax({
                url: "PurchaseRejectd.ashx?PrId="+Id,
                type: "GET",
                dataType: "json",
                async: false,
            ...
            if (billStatus == 1000) {
                $(this).parent().prev().html("已退回");
                alert("退回成功！");
            }
            if (billStatus == 0) {
                $(this).parent().prev().html("<font color=\"#FF0000\">待退回</font>");
                alert("撤销退回成功！");
            }
