<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" CodeBehind="ImportJDRealTimeInventory.aspx.cs" Inherits="HozestERP.Web.ManageInventory.ImportJDRealTimeInventory" %>
    ...
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        <tr>
            ...
            <td style="width: 450px;">
                项目&nbsp;&nbsp;<asp:DropDownList ID="ddXMProject" Width="40%" runat="server" OnSelectedIndexChanged="ddXMProject_SelectedIndexChanged"
                    AutoPostBack="true">
                </asp:DropDownList>
                &nbsp;&nbsp;店铺 &nbsp;&nbsp;
        ...
        <tr>
            ...
            <td>
                <asp:HyperLink ID="SaleDeliveryModel" runat="server" ForeColor="Red" Visible="false"
                    NavigateUrl="~/Template/自营动销表格.xlsx">下载京东自营销售模板</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td style="width: 8px; height: 8px">
