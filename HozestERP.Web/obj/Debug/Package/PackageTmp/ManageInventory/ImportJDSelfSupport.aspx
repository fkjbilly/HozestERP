<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" CodeBehind="ImportJDSelfSupport.aspx.cs" Inherits="HozestERP.Web.ManageInventory.ImportJDSelfSupport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" NavigateUrl="~/Template/京东自营采购入库单模板.xls">下载采购入库单模板</asp:HyperLink>
            </td>
            <td>
            </td>
        </tr>
