<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
 AutoEventWireup="true" CodeBehind="ImportBusinessDataB2B.aspx.cs" Inherits="HozestERP.Web.ManageBusiness.ImportBusinessDataB2B" %>
          ...
          <td style="width: 8px; height: 8px">
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" 
                    NavigateUrl="~/Template/B2B导入模板.xlsx">下载B2B导入模板</asp:HyperLink>
            </td> 
            <td>&nbsp;</td>
        </tr>
