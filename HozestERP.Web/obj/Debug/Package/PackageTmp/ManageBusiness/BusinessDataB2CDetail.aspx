<%@ Page Language="C#" CodeBehind="BusinessDataB2CDetail.aspx.cs" MasterPageFile="~/MasterPages/CommonEdit.Master"
 AutoEventWireup="true" Inherits="HozestERP.Web.ManageBusiness.BusinessDataB2CDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <table width="100%" border="0" cellspacing="0" cellpadding="3">
    <tbody>
            ...
            Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2CDetail.ContractNumberSave %>"/>
            </td>
            ...
            <asp:Button ID="btnSave" runat="server" Text="保存"  ValidationGroup="ModuleValidationGroup"
                    OnClick="btnSave_Click"  Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2CDetail.Save %>"/>

                    <asp:Button ID="btnSpendingAuthority" runat="server" Text="支付查看权限"  ValidationGroup="ModuleValidationGroup"
                         Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2CDetail.SpendingAuthority %>"/>
            </td></tr>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="到账类型"  SortExpression="BusinessTypeName">
            <HeaderStyle Width="80px" HorizontalAlign="Center" Wrap="False" />
            <ItemTemplate>
        ...
        <asp:TemplateField HeaderText="业务类型"  SortExpression="B2CBusinessTypeName">
            <HeaderStyle Width="80px" HorizontalAlign="Center" Wrap="False" />
            <ItemTemplate>
             <%# Eval("B2CBusinessTypeName")%>
            </ItemTemplate>
            <EditItemTemplate>
                 <asp:DropDownList ID="ddlB2CBusinessType" runat="server" Width="92%">
                 </asp:DropDownList>
            </EditItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="操作"> 
            ...
            <ItemTemplate>
                <asp:ImageButton ID="imgBtnAudit" runat="server" ImageUrl="~/App_Themes/Default/Image/audit.jpg" CommandArgument='<%#Eval("ID")%>'
                        ToolTip="审核" CommandName="Audit" CausesValidation="False" Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2CDetail.Audit %>" />

                <asp:ImageButton ID="imgBtnEdit" runat="server" ImageUrl="~/App_Themes/Default/Image/update.gif"
                        ToolTip="编辑" CommandName="Edit" CausesValidation="False" Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2CDetail.Edit %>" />
                ...
                <asp:ImageButton ID="imgBtnDelete" runat="server" ImageUrl="~/App_Themes/Default/Image/close02.gif" CommandArgument='<%#Eval("ID")%>'
                        ...
                        Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2CDetail.Delete %>" />
                
            </ItemTemplate>
            <EditItemTemplate>  
                    <asp:ImageButton ID="imgBtnUpdate" runat="server" ImageUrl="~/App_Themes/Default/Image/save.gif" ToolTip="保存"
                        CommandName="Update" CausesValidation="True" Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2CDetail.EditSave %>"/>
                    <asp:ImageButton ID="imgBtnCancel" runat="server" ImageUrl="~/App_Themes/Default/Image/Cancel.gif" ToolTip="取消"
                        CommandName="Cancel" CausesValidation="False" Visible="<% $CRMIsActionAllowed:ManageBusiness.BusinessDataB2CDetail.EditCancel %>"/>
              </EditItemTemplate>
        </asp:TemplateField>
