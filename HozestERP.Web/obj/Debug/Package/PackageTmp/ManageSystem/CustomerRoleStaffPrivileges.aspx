<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerRoleStaffPrivileges.aspx.cs"
    Inherits="HozestERP.Web.ManageSystem.CustomerRoleStaffPrivileges" %>
        ...
        <Items>
              <ext:GridPanel ID="GridPanel1" Region="Center" runat="server" StripeRows="true" AutoExpandColumn="FullName"
                ...
                <TopBar>
                    <ext:Toolbar>
                        <Items>
                            <ext:Button Text="添加人员" ID="btnAddCustomer" runat="server" Icon="Add" OnClientClick="return ShowSelectCustomerDetail('CustomerRoleSelectCustomer.aspx?PageID=CustomerRoleStaffPrivileges');" >
                                <DirectEvents>
