<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="HozestERP.Web.Modules.DecimalTextBox" Codebehind="DecimalTextBox.ascx.cs" %>
 
<asp:TextBox ID="txtValue" runat="server" style="text-align:right;"></asp:TextBox>
