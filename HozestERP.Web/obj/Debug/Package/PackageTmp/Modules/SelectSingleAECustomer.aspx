<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectSingleAECustomer.aspx.cs"
    Inherits="HozestERP.Web.Modules.SelectSingleAECustomer" %>
                                                            ...
                                                            <asp:GridView ID="grdCustomer" runat="server" AutoGenerateColumns="False" DataKeyNames="CustomerID"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="星级">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <%# (Container.DataItem as CustomerInfo).StarLv != null ? (Container.DataItem as CustomerInfo).StarLv : 1%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="可操作客户数">
                                                                        <HeaderStyle CssClass="GridHeard" HorizontalAlign="Center" />
                                                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                        <ItemTemplate>
                                                                             <%# (Container.DataItem as CustomerInfo).ServerCount != null ? (Container.DataItem as CustomerInfo).ServerCount : 0%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="已操作客户数">
                                                                        <HeaderStyle CssClass="GridHeard" HorizontalAlign="Center" />
                                                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                        <ItemTemplate>
                                                                        <%# (Container.DataItem as CustomerInfo).ContractCount%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="暂停客户数">
                                                                        <HeaderStyle CssClass="GridHeard" HorizontalAlign="Center" />
                                                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                        <ItemTemplate>
                                                                        <%# (Container.DataItem as CustomerInfo).PauseContractCount%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
