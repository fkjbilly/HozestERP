<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true"
    CodeBehind="XMDataAnalysisApplicationType.aspx.cs" Inherits="HozestERP.Web.ManageApplication.XMDataAnalysisApplicationType" %>
    ...
    <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnSearch">
        <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
            <tr>
                ...
                <td style="width: 120px">
                    <asp:DropDownList ID="ddlApplicationType" Width="100%" runat="server">
              ...
              <td> 
               ...
               <asp:Button ID="hidBtnSearch" runat="server" Style="width: 0px; display: none;" ToolTip="刷新"  
                ...
                <asp:Button ID="btnSearch" runat="server" Text="查询" Visible="<% $CRMIsActionAllowed:XMDataAnalysisApplicationType.Search %>"
                        OnClick="btnSearch_Click" /> 

                </div> 
             
                                <asp:Button ID="btnDaochu" runat="server" Text="导出" Visible="<% $CRMIsActionAllowed:XMDataAnalysisApplicationType.Daochu %>"
