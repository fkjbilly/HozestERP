<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true"
    CodeBehind="XMDataAnalysisApplication.aspx.cs" Inherits="HozestERP.Web.ManageApplication.XMDataAnalysisApplication" %>
            ...
            <tr>
              ...
              <td colspan="3"> 
               ...
               <asp:Button ID="hidBtnSearch" runat="server" Style="width: 0px; display: none;" ToolTip="刷新"  
                ...
                <asp:Button ID="btnSearch" runat="server" Text="查询" Visible="<% $CRMIsActionAllowed:XMDataAnalysisApplication.Search %>"
                        OnClick="btnSearch_Click" /> 

                </div> 
             
                                <asp:Button ID="btnDaochu" runat="server" Text="导出" Visible="<% $CRMIsActionAllowed:XMDataAnalysisApplication.Daochu %>"
