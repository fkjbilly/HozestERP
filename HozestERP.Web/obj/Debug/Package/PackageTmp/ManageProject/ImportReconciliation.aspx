<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
 AutoEventWireup="true" CodeBehind="ImportReconciliation.aspx.cs" Inherits="HozestERP.Web.ManageProject.ImportReconciliation" %>
          ...
          <td style="width: 8px; height: 8px">
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" 
                    NavigateUrl="~/Template/亚马逊对账模板.xls">下载亚马逊对账模板</asp:HyperLink>
            </td> 
            <td>&nbsp;</td>
        </tr>
