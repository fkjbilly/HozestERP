<%@ Page Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master" AutoEventWireup="true" CodeBehind="ImportJdSaleLogisticsFee.aspx.cs" Inherits="HozestERP.Web.ManageProject.ImportJdSaleLogisticsFee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" NavigateUrl="~/Template/京东自营退货单物流费用模板.xls">下载京东自营退货单物流费用模板</asp:HyperLink>
            </td>
            <td>
                &nbsp;
            </td>
