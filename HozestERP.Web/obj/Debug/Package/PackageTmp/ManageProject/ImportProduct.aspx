<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master" AutoEventWireup="true" CodeBehind="ImportProduct.aspx.cs" Inherits="HozestERP.Web.ManageProject.ImportProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 450px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" NavigateUrl="~/Template/产品导入模板.xlsx">下载产品导入模板</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td>
