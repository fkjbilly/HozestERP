<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" CodeBehind="XMSpareAddressEdit.aspx.cs" Inherits="HozestERP.Web.ManageProject.XMSpareAddressEdit" %>
                ...
                <td valign="top">
                    <table class="detailTableo" width="100%" border="0" cellspacing="0" cellpadding="3">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; width: 180px;">
                                <asp:TextBox runat="server" ID="txtFullName" Style="width: 80%;" MaxLength="5"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; width: 60px;">
                            ...
                            <td style="text-align: left; width: 180px;">
                                <asp:TextBox runat="server" ID="txtMobile" Style="width: 80%;" MaxLength="11"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; width: 60px;">
                            ...
                            <td style="text-align: left; width: 180px;">
                                <asp:TextBox runat="server" ID="txtTel" Style="width: 80%;" MaxLength="15"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right; width: 60px;">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnSave" runat="server" Text="保存" ValidationGroup="ModuleValidationGroup"
                    OnClick="btnSave_Click" Visible="<% $CRMIsActionAllowed:ManageProject.XMSpareAddressEdit.Save %>" />
            </td>
        </tr>
    </table>
</asp:Content>
