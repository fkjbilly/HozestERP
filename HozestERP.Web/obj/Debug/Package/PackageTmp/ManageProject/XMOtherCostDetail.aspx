<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true"
    CodeBehind="XMOtherCostDetail.aspx.cs" Inherits="HozestERP.Web.ManageProject.XMOtherCostDetail" %>
    ...
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        <tr>
            ...
            <td style="text-align: right;">
                ...
                <asp:Button ID="btnSetField" runat="server" Text="设置" Visible="<% $CRMIsActionAllowed:XMOtherCostDetail.SetFinancialFieldOther %>" />&nbsp;
                <asp:Button ID="btnIsAudit" SkinID="button4" runat="server" Text="审核" OnClick="btnIsAudit_Click"
                    Visible="<% $CRMIsActionAllowed:XMOtherCostDetail.IsAudit %>" />&nbsp;
                <asp:Button ID="btnIsAuditFalse" SkinID="button4" runat="server" Text="反审核" OnClick="btnIsAuditFalse_Click"
                    Visible="<% $CRMIsActionAllowed:XMOtherCostDetail.IsAuditFalse %>" />&nbsp;
                <asp:Button ID="btnImportCost" SkinID="button4" runat="server" Text="导入数据" Visible="<% $CRMIsActionAllowed:XMProjectCostDetail.ImportCost %>" />
                &nbsp;
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contentplaceholder3" runat="server">
    ...
    <div style="overflow: scroll; height: 100%; float: left; width: 70%; margin-left: -3px"
        id="DivGridView">
        <asp:GridView ID="grdvOtherCost" runat="server" AutoGenerateColumns="False" DataKeyNames="Id,FinancialFieldID"
