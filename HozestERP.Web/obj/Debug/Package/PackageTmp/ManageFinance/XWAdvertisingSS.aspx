<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true" 
 CodeBehind="XWAdvertisingSS.aspx.cs" Inherits="HozestERP.Web.ManageFinance.XWAdvertisingSS" %>
            ...
            <HeaderStyle Wrap="False" Width="20px" HorizontalAlign="Center"></HeaderStyle>
             ...
             <asp:TemplateField>
                ...
                <ItemTemplate>
                    ...
                    <asp:HiddenField ID="hdPSId" Value='<%#Eval("Id")%>' runat="server" />
                </ItemTemplate>
            </asp:TemplateField>  
...
<%--             <%# (Container.DataItem as HozestERP.BusinessLogic.ManageFinance.CWPlatformSpendingMapping).PlatformName %> 
         ...
         <asp:TemplateField HeaderText="时间"  >
            ...
            <ItemTemplate>
                <input style="background:transparent;border:0; width:150px; " value='<%#  Convert.ToDateTime(Eval("Feedate")).ToString("yyyy-MM-dd")%>' readonly="readonly" runat="server" id="lblProjectExplanation" />
            </ItemTemplate> 
         </asp:TemplateField> 
         ...
         <asp:TemplateField HeaderText="广告费用"  >
            ...
            <ItemTemplate>
                <asp:TextBox runat="server" ID="txtCountMoney" Text='<%# Eval("Fee")==null?"0":Eval("Fee")%>' Width="90%"  style="text-align:right" ></asp:TextBox>
             ...
             <FooterTemplate>  
              <asp:ImageButton ID="imgBtnCountMoneySave" OnClick="imgBtnCountMoneySave_Click" runat="server"  ImageUrl="~/App_Themes/Default/Image/save.gif" ToolTip="保存" 
                Visible="<% $CRMIsActionAllowed:ManageFinance.CWPlatformSpendingDetails.save2 %>"/> 
