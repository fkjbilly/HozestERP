<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWProjectList.aspx.cs" Inherits="HozestERP.Web.ManageFinance.CWProjectList" %> 

<html>
<head id="Head1" runat="server">
    <title></title>
    <script type="text/javascript" language="javascript" src="../Script/Menu.js"></script>
    <link href="../App_Themes/Blue/OA.css" rel="stylesheet" type="text/css" />
</head>
                    ...
                    <tr>
                        <td>
                            <iframe id="IframeTree" scrolling="yes" style="color: Black" frameborder="0" height="100%"
                                marginheight="0" scrolling="no" border="0" marginwidth="0" name="Model" src="CWProjectTree.aspx"
                                ...
                                <tr>
                                    <td>
                                        <iframe id="ModuleContentPage" frameborder="0" height="100%" marginheight="0" marginwidth="0"
                                            scrolling="auto" name="ModuleContentPage" src="CWProjectDetails.aspx" style="border-top-style: none;
