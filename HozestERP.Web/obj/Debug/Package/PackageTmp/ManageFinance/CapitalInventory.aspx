<%@ Page Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true"
    CodeBehind="CapitalInventory.aspx.cs" Inherits="HozestERP.Web.ManageFinance.CapitalInventory" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" style="width: 100%">
        <tr>
            ...
            <td style="width: 100px;">
                <asp:DropDownList ID="ddlCompany" Width="100%" runat="server">
                </asp:DropDownList>
            </td>
            <td style="text-align: right">
                <asp:Button ID="btnSearch" runat="server" Text="查询" OnClick="btnSearch_Click" />
                <asp:Button ID="btnExport" SkinID="button4" runat="server" Text="导出数据" OnClick="btnExport_Click"
                    Visible="<% $CRMIsActionAllowed:ManageFinance.CapitalInventory.Export %>" />
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contentplaceholder3" runat="server">
    <div align="center" style="width: 100%; border: 0px; margin-top：0px;">
        ...
        <font size='5'><b>货币资金盘存表</b></font>
        <p>
        </p>
        <table align="center" style="width: 100%; border: 1px; background-color: #A52A2A;">
            <tr style="height: 40px; border: 1px;">
                <th style="border: 1px solid; width: 30%;">
                    <font size='3'><b>名称</b></font>
                </th>
                <th style="border: 1px solid; width: 20%;">
                    <font size='3'><b>期初余额</b></font>
                </th>
                <th style="border: 1px solid; width: 15%;">
                    <font size='3'><b>收入</b></font>
                </th>
                <th style="border: 1px solid; width: 15%;">
                    <font size='3'><b>支出</b></font>
                </th>
                <th style="border: 1px solid; width: 20%;">
                    <font size='3'><b>期末余额</b></font>
                </th>
            </tr>
            <%=TableStr %></table>
    </div>
