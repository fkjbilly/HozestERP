<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true" 
 CodeBehind="CWPlatformSpendingDetailsSS.aspx.cs" Inherits="HozestERP.Web.ManageFinance.CWPlatformSpendingDetailsSS" %>
...
<%--             <asp:Label ID="lblPlatformName" runat="server"></asp:Label>
         ...
         <asp:TemplateField HeaderText="平台名称"  >
            ...
            <ItemTemplate>
                <input style="background:transparent;border:0; width:150px; " value='<%# Eval("Remarks")%>' readonly="readonly" runat="server" id="lblProjectExplanation" />
            </ItemTemplate>
         </asp:TemplateField> 
         ...
         <asp:TemplateField HeaderText="金额"  >
            ...
            <ItemTemplate>
<%--                <asp:TextBox runat="server" ID="txtCountMoney" Text='<%# Eval("PayPrice")==null?"0":Eval("PayPrice")%>' Width="90%"  style="text-align:right" ></asp:TextBox>
                 <div style="text-align:center; width:100%;">--%>
                 <asp:Label ID="lblMsgCountMoneyVaule" runat="server"  Text='<%# Eval("PayPrice")==null?"0":Convert.ToDouble(Eval("PayPrice")).ToString("0.00")%>'></asp:Label>
                 </div>
            </ItemTemplate> 
