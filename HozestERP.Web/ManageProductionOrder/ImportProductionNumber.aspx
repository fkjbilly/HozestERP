<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" CodeBehind="ImportProductionNumber.aspx.cs" Inherits="HozestERP.Web.ManageProductionOrder.ImportProductionNumber" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" NavigateUrl="~/Template/生产单导入模板.xls">下载生产单导入模板</asp:HyperLink>
            </td>
            <td>
            </td>
        </tr>
