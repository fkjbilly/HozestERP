...
{
    public partial class ImportProductionNumber : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        string partpath = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath) + @"\UpLoad\ImportProductionNumber";
                        ...
                        base.ImportManager.ImportProductionNumberFromXls(serpath, ref paramMessage);
