...
{
    public partial class SelectCustomer : BaseAdministrationPage
    {
        ...
        public List<int> CustomerStatus
        {
            get
            {
                ...
                try
                {
                    string[] strStatus = Session[this.SessionID + "SelectCustomersStatus"].ToString().Split(',');
        ...
        public List<CustomerInfo> SelectCustomers
        {
            get
            {
                try
                {
                    return (Session[this.SessionID + "SelectCustomerInfos"] as List<CustomerInfo>);
                }
                catch
                {
                }
            ...
            set
            {
                Session[this.SessionID + "SelectCustomerInfos"] = value;
            }
        }
        ...
        public string SessionID
        {
            get
            {
                return CommonHelper.QueryString("SessionID");
            }
        } 
