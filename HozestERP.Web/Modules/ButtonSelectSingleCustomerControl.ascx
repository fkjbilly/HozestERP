<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ButtonSelectSingleCustomerControl.ascx.cs"
    Inherits="HozestERP.Web.Modules.ButtonSelectSingleCustomerControl" %>
