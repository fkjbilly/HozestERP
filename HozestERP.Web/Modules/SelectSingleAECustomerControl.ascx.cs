...
{
    public partial class SelectSingleAECustomerControl : BaseAdministrationUserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                this.iBtnSelect.OnClientClick = "return Show" + this.SessionPageID + "CustomerDetail('" + CommonHelper.GetStoreLocation() + "Modules/SelectSingleAECustomer.aspx?SessionPageID=" + this.SessionPageID +"&DepartmentID=" + this.DepartmentID + "');";
            }
        }
    ...
    public partial class SelectedAECustomerEventArgs : EventArgs
    {
        /// <summary>
        /// Gets or sets the customer
        /// </summary>
        public CustomerInfo SelectSingleAECustomer { get; set; }
    }
}