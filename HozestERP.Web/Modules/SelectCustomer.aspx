<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectCustomer.aspx.cs"
    Inherits="HozestERP.Web.Modules.SelectCustomer" %>
                        ...
                        <tr style="height: 100%;">
                            ...
                            <td colspan="6" style="height: 100%; overflow: hidden;">
                                <div style="width: 100%; height: 100%; overflow: auto; position: relative;">
                                    <asp:UpdatePanel ID="upanletree" runat="server" style="position: absolute;">
                                        <ContentTemplate>
                                                ...
                                                <div style="width: 100%; height: 100%; overflow: auto; position: relative;">
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" style="position: absolute; width: 100%;">
                                                        <ContentTemplate>
                                                            ...
                                                            <CRM:GridNevigator ID="GridNevigator1" runat="server" PageSize="10" OnPageChange="GridNevigator1_PageChange"  OnPageSizeChange="GridNevigator1_PageSizeChange"/>
                                                        </ContentTemplate>
                                                        <Triggers>
                                ...
                                <td align="left" id="tdContent2" runat="server" style="height: 40px;">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnSelect" runat="server" Text="确认" OnClientClick="javascript:window.close();" />
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                        </tr>
                        ...
                        <tr id="tr2" class="EidtHead">
                            ...
                            <td colspan="6">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td style="vertical-align: middle">
                                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="已选择人员"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td colspan="6" style="height: 100%; overflow: hidden;">
                                <div style="width: 100%; height: 100%; overflow: auto; position: relative;">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" style="position: absolute; width: 100%;">
                                        <ContentTemplate>
                                            <asp:GridView ID="grdSelectCustomer" runat="server" AutoGenerateColumns="False" DataKeyNames="CustomerID"
