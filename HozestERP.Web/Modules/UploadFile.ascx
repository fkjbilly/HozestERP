<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UploadFile.ascx.cs"
    Inherits="HozestERP.Web.Modules.UploadFile" %>
                        ...
                        <asp:Repeater ID="rpFiles" runat="server" OnItemCommand="rpFiles_ItemCommand">
                            <ItemTemplate>
                                <div style="float: left; padding-right: 10px;">
                                    <a href="#" onclick="window.open('<%# CommonHelper.GetStoreLocation()%>ManageFile/GetDownload.ashx?FilePath=../Upload/XMQuestionDetailImg/<%# Eval("Url")%>&Filename=<%# Eval("FullName") %>');return false;"
                                        target="_blank">
