...
{
    public partial class CommonEdit : BaseAdministrationMasterPage
    {
        ...
        /// 
        /// </summary>
        public bool SetTitleTabPanelVisible
        {
            set
            {
                if (value)
                {
                    this.trEditHead.Style.Add("display", "");
                }
                else
                {
                    this.trEditHead.Style.Add("display", "none");
                }
            }
        }
