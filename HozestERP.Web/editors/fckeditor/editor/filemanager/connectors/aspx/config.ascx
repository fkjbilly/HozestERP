...
<script runat="server">
	...
	private bool CheckAuthentication()
	{
        ...
        bool isAdmin = HozestERP.BusinessLogic.CRMContext.Current != null &&
            HozestERP.BusinessLogic.CRMContext.Current.User != null &&
            HozestERP.BusinessLogic.CRMContext.Current.User.IsAdmin;
        return isAdmin;
	}
