<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PsnAvatarEdit.aspx.cs"
    Inherits="HozestERP.Web.ManageSystem.PsnAvatarEdit" %>
...
<body style="background-color: White;">
    ...
    <table class="detailTable" style="float: left; background-color: White; margin: 5px 5px 5px 5px;"
        ...
        <tr>
            ...
            <td>
                <SHIBR:UpdateImageControl ID="imgUpload" runat="server" />
            </td>
        </tr>
        <tr>
