<%@ Page Language="C#" CodeBehind="DemandAdd.aspx.cs" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" Inherits="HozestERP.Web.ManageSystem.DemandAdd" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tbody>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:TextBox runat="server" ID="txtdemand" Width="100%"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="width: 80px" align="left">
                ...
                <td align="left">
                    <asp:TextBox runat="server" ID="txtPrice" Width="100%"></asp:TextBox>
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnSave" runat="server" Text="保存" ValidationGroup="ModuleValidationGroup"
                    OnClick="btnSave_Click" Visible="<% $CRMIsActionAllowed:ManageSystem.ZMtypeAdd.Save %>" />
            </td>
        </tr>
    </table>
</asp:Content>
