<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerRoleSelectCustomer.aspx.cs"
    Inherits="HozestERP.Web.Modules.CustomerRoleSelectCustomer" %>
                                ...
                                <td align="left" id="tdContent2" runat="server" style="height: 40px;">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnSelect" runat="server" Text="确认" 
