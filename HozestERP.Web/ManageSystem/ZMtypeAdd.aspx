<%@ Page Language="C#" CodeBehind="ZMtypeAdd.aspx.cs" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" Inherits="HozestERP.Web.ManageSystem.ZMtypeAdd" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="3">
        <tbody>
            <tr>
                ...
                <td align="left">
                    <asp:TextBox runat="server" ID="txtInstallationtype" Width="100%"></asp:TextBox>
                </td>
            </tr>
        </tbody>
    </table>
