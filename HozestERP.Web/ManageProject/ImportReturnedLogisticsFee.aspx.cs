...
{
    public partial class ImportReturnedLogisticsFee : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        base.ImportManager.ImportReturnedLogisticsFee(serpath, ref paramMessage);
