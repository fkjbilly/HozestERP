...
{
    public partial class ImportEditFactoryPrice : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        string partpath = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath) + @"\UpLoad\XMProductManage";
                        ...
                        base.ImportManager.ImportFactoryPriceXls(serpath, ref paramMessage);
