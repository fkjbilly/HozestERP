...
{
    public partial class ImportVPHLogistics : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        string partpath = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath) + @"\UpLoad\ImportVPHLogistics";
                        ...
                        base.ImportManager.ImportVPHLogistics(serpath, ref paramMessage);
