<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" CodeBehind="ImportVPHLogistics.aspx.cs" Inherits="HozestERP.Web.ManageProject.ImportVPHLogistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" NavigateUrl="~/Template/运单承运商导入模板.xls">下载运单承运商导入模板</asp:HyperLink>
            </td>
            <td>
                &nbsp;
            </td>
