<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" CodeBehind="ImportXLMInventory.aspx.cs" Inherits="HozestERP.Web.ManageProject.ImportXLMInventory" %>
    ...
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        <%--<tr>
            ...
            <td style="width: 400px; height:45px;">
                <asp:DropDownList ID="ddlWarehouse" runat="server" Width="100%" Height="65%">
                </asp:DropDownList>
            </td>
        </tr>--%>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" NavigateUrl="~/Template/喜临门库存导入模板.xls">喜临门库存导入模板</asp:HyperLink>
            </td>
            <td>
                &nbsp;
            </td>
