<%@ Page Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master" AutoEventWireup="true" CodeBehind="ImportClaimInfo.aspx.cs" Inherits="HozestERP.Web.ManageProject.ImportClaimInfo" %>
          ...
          <td style="width: 8px; height: 8px">
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" 
                    NavigateUrl="~/Template/理赔对账导入模板.xls">下载理赔对账导入模板</asp:HyperLink>
            </td> 
            <td>&nbsp;</td>
        </tr>
