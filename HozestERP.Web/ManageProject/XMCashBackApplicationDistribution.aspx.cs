...
{ 
    ...
    public partial class XMCashBackApplicationDistribution : BaseAdministrationPage, IEditPage
    {
        ...
        public string SelectExplanation
        {
            get
            {
                try
                {
                    return (Session["SelectExplanation"] as string);
                }
                catch
                {
                }
            ...
            set
            {
                Session["SelectExplanation"] = value;
            }
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtExplanation!="")
                {
                    this.SelectExplanation = txtExplanation.ToString();  
