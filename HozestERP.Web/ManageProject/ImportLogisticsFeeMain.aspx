<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
 AutoEventWireup="true" CodeBehind="ImportLogisticsFeeMain.aspx.cs" Inherits="HozestERP.Web.ManageProject.ImportLogisticsFeeMain" %>
          ...
          <td style="width: 8px; height: 8px">
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" 
                    NavigateUrl="~/Template/导入干线物流模板.xls">下载导入干线物流模板</asp:HyperLink>
            </td> 
            <td>&nbsp;</td>
        </tr>
