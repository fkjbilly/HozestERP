...
{
    public partial class ImportReconciliation : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        string partpath = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath) + @"\UpLoad\ImportReconciliation";
                        ...
                        base.ImportManager.ImportImportReconciliation(serpath, ref paramMessage);
