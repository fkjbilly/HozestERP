...
CodeBehind="ProjectXMDeductionSetUpTypeCashBack.aspx.cs" Inherits="HozestERP.Web.ManageProject.ProjectXMDeductionSetUpTypeCashBack"  EnableEventValidation="true"  %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:GridView ID="gvProjectXMDeductionSetUpTypeCashBack" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
        SkinID="GridViewThemen" OnRowCancelingEdit="gvProjectXMDeductionSetUpTypeCashBack_RowCancelingEdit" OnRowDeleting="gvProjectXMDeductionSetUpTypeCashBack_RowDeleting"
        OnRowEditing="gvProjectXMDeductionSetUpTypeCashBack_RowEditing" OnRowUpdating="gvProjectXMDeductionSetUpTypeCashBack_RowUpdating"
        OnRowDataBound="gvProjectXMDeductionSetUpTypeCashBack_RowDataBound">
        <Columns>
        ...
        <asp:TemplateField HeaderText="项目限额" SortExpression="Deduction">
        ...
        <asp:TemplateField HeaderText="财务限额" SortExpression="Finance">
            <HeaderStyle Width="80px" HorizontalAlign="Center" Wrap="False" />
                <ItemStyle Width="80px" HorizontalAlign="Center" Wrap="False" />
            <ItemTemplate>
                <%# Eval("Finance")%>
            ...
            <EditItemTemplate>
                <asp:TextBox ID="txtFinance" runat="server" Width="90%" Text='<%# Eval("Finance") %>' MaxLength="20" ValidationGroup="DeductionValidationGroup"></asp:TextBox>
                  <div style="text-align:center; width:100%;">
                 <asp:Label ID="lblMsgFinanceVaule" runat="server" Text="" ForeColor="red"></asp:Label>
                </div>
            </EditItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="操作">
                ...
                <ItemTemplate>
                    <asp:ImageButton ID="imgBtnEdit" runat="server" ImageUrl="~/App_Themes/Default/Image/update.gif"
                        ToolTip="编辑" CommandName="Edit" CausesValidation="False" Visible="<% $CRMIsActionAllowed:ProjectXMDeductionSetUpTypeCashBack.Edit %>" />
                    ...
                    <asp:ImageButton ID="imgBtnDelete" runat="server" ImageUrl="~/App_Themes/Default/Image/close02.gif"
                        ...
                        Visible="<% $CRMIsActionAllowed:ProjectXMDeductionSetUpTypeCashBack.Delete %>" />
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:ImageButton ID="imgBtnUpdate" runat="server" ImageUrl="~/App_Themes/Default/Image/save.gif"
                        ToolTip="保存" CommandName="Update" CausesValidation="True"  ValidationGroup="DeductionValidationGroup" Visible="<% $CRMIsActionAllowed:ProjectXMDeductionSetUpTypeCashBack.Save %>" />

                    <asp:ImageButton ID="imgBtnCancel" runat="server" ImageUrl="~/App_Themes/Default/Image/Cancel.gif"
                        ToolTip="取消" CommandName="Cancel" CausesValidation="False" Visible="<% $CRMIsActionAllowed:ProjectXMDeductionSetUpTypeCashBack.Cancel %>" />
                </EditItemTemplate>
            </asp:TemplateField>     
    </Columns>
</asp:GridView>
