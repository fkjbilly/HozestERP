...
{
    public partial class ImportOrderAscription : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        string partpath = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath) + @"\UpLoad\ImportOrderAscription";
                        ...
                        base.ImportManager.ImportOrderAscriptionFormXls(serpath, ref paramMessage);
