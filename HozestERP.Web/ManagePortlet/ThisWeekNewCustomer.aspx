<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThisWeekNewCustomer.aspx.cs"
    Inherits="HozestERP.Web.ManagePortlet.ThisWeekNewCustomer" %>
...
<body style="background-color:White;">
    ...
    <div class="portlet_content">
        <table style="width: 100%;">
            <%
                var emptyLikeStr = "%%";
                var contracts = base.ContractService.GetClientThisWeekNewCustomerDesktopList(HozestERPContext.Current.User.CustomerID, emptyLikeStr, emptyLikeStr, -1, -1, -1,
            ...
            <tr style="width: 100%; height: 5px;">
                ...
                <td style="width: 20%; text-align: right; border-bottom-color: #b9cadd; border-bottom-width: 1px; border-bottom-style: dashed;padding-top:4px;">
                    合同金额:&nbsp;￥<span style="color:Red;font-weight:bold;"><%= Math.Round(contract.Amount,2).ToString() %></span>&nbsp;
                </td>
                <td style="width: 20%; text-align: right; border-bottom-color: #b9cadd; border-bottom-width: 1px; border-bottom-style: dashed;padding-top:4px;">
                    签订日期:&nbsp;<span><%= contract.ContractDate.ToString("yyyy/MM/dd") %></span>&nbsp;
                </td>
            </tr>
            <%}%>
        </table>
