...
{
    public partial class XMDataAnalysisApplicationType : BaseAdministrationPage, ISearchPage
    {
        ...
        protected void btnDaochu_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    this.BindGrid(Master.PageIndex, Master.PageSize);
                    base.ExportManager.ExportDataAnalysisXlsApplicationType(filePath, xmConsultationAll, xmConsultationTotal);
