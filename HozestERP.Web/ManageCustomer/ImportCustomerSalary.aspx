<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
 AutoEventWireup="true" CodeBehind="ImportCustomerSalary.aspx.cs" Inherits="HozestERP.Web.ManageCustomer.ImportCustomerSalary" %>
          ...
          <td style="width: 8px; height: 8px">
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" 
                    NavigateUrl="~/Template/月薪资模板.xls">下载月薪资模板</asp:HyperLink>
            </td> 
            <td>&nbsp;</td>
        </tr>
