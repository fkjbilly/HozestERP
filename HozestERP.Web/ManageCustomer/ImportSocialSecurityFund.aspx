<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/CommonEdit.Master"
    AutoEventWireup="true" CodeBehind="ImportSocialSecurityFund.aspx.cs" Inherits="HozestERP.Web.ManageCustomer.ImportSocialSecurityFund" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table border="0" cellpadding="2" cellspacing="2" style="width: 100%">
        ...
        <tr>
            ...
            <td style="width: 400px;">
                <asp:HyperLink ID="DownTemp" runat="server" ForeColor="Red" NavigateUrl="~/Template/社保公积金模板.xlsx">社保公积金模板</asp:HyperLink>
            </td>
            <td>
                &nbsp;
            </td>
