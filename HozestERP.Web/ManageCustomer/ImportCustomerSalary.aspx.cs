...
{
    public partial class ImportCustomerSalary : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        string partpath = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath) + @"\UpLoad\ImportCustomerSalary";
                        ...
                        base.ImportManager.ImportImportCustomerSalary(serpath, ref paramMessage);
