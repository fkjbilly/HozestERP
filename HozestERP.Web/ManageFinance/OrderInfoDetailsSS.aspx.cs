...
{  
    public partial class OrderInfoDetailsSS : BaseAdministrationPage, ISearchPage
    { 
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            { 
                ...
                //if (this.min != "")
                //{
                //    this.txtBeginDate.SelectedDate = DateTime.Parse(this.min);
                //}
                //if (this.max != "")
                //{
                //    this.txtEndDate.SelectedDate = DateTime.Parse(this.max);
                //}
        ...
        public void BindGrid(int paramPageIndex, int paramPageSize)
        {
            ...
            List<OrderInfoSalesDetails> xmOrderInfoList = base.XMOrderInfoService.getXMOrderInfoList(Convert.ToInt32(this.ddlPlatformTypeId.SelectedValue), nickIdList, Convert.ToDateTime(OrderInfoModifiedStart), Convert.ToDateTime(OrderInfoModifiedEnd), Convert.ToInt32(this.OrderStatusId), "");
            ...
            if (BrandType != "-1")
            {
                xmOrderInfoList = base.XMOrderInfoService.GetXMOrderInfoListByBrandType(xmOrderInfoList, int.Parse(BrandType));
            }
            
            var pageList = new PagedList<OrderInfoSalesDetails>(xmOrderInfoList, paramPageIndex, paramPageSize);
            this.Master.BindData(this.grdOrderInfoDetailsList, pageList);
        }
        ...
        protected void grdOrderInfoDetailsList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
