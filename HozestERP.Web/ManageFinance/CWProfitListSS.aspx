<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Root.Master"
    CodeBehind="CWProfitListSS.aspx.cs" Inherits="HozestERP.Web.ManageFinance.CWProfitListSS" %>
                                ...
                                <ContentTemplate>
                                    <table border="1" cellpadding="2" cellspacing="2" style="width: 100%">
                                        ...
                                        <tr style="background-color: rgb(220,220,220); text-align: center;">
                                            <%--<td style="font-weight:bold;">营业成本合计</td>--%>
                                            <td>
                                                进货成本
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <%--        <td><asp:Label ID="lblPTCBFYMonthMoney2" runat="server"></asp:Label></td>
                                            --%>
                                            <td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="tbInstallation" runat="server" ReadOnly="true" Width="98%" Style="text-align: right"></asp:TextBox>
                                            </td>
                                            <td>
