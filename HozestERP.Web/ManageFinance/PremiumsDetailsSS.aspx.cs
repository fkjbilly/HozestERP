...
{ 
    public partial class PremiumsDetailsSS : BaseAdministrationPage, ISearchPage
    {
        ...
        public void BindGrid(int paramPageIndex, int paramPageSize)
        {
            ...
            if (this.ddlNickList.SelectedValue != null && this.ddlNickList.SelectedValue!="")
            {
            ...
            //赠品明细
            var XMOrderInfoAndPremiumsDetailsList = base.XMOrderInfoService.getXMOrderInfoAndPremiumsDetailsList(Convert.ToInt32(PlatformTypeId), nickIdList, Convert.ToDateTime(OrderInfoModifiedStart), Convert.ToDateTime(OrderInfoModifiedEnd), Convert.ToInt32(OrderStatusId));


            var pageList = new PagedList<OrderInfoSalesDetails>(XMOrderInfoAndPremiumsDetailsList, paramPageIndex, paramPageSize);

            this.Master.BindData(this.grdPremiumsDetailsList, pageList);
        ...
        protected void grdPremiumsDetailsList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
