...
{  
    public partial class XMScalpingDetailsSS : BaseAdministrationPage, ISearchPage
    {
        ...
        public void BindGrid(int paramPageIndex, int paramPageSize)
        {
            ...
            List<OrderInfoSalesDetails> XMScalpingDetailsList = base.XMScalpingService.GetXMScalpingDetailsList
               (Convert.ToInt32(this.ddlPlatformTypeId.SelectedValue), nickIdList, Convert.ToDateTime(OrderInfoModifiedStart), Convert.ToDateTime(OrderInfoModifiedEnd), Convert.ToInt32(this.OrderStatusId));

            var pageList = new PagedList<OrderInfoSalesDetails>(XMScalpingDetailsList, paramPageIndex, paramPageSize);

            this.Master.BindData(this.grdXMScalpingDetailsList, pageList);
        ...
        protected void grdXMScalpingDetailsList_RowDataBound(object sender, GridViewRowEventArgs e)
        {
