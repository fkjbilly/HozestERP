...
{ 
    ...
    public partial class CWPlatformSpendingDetails : BaseAdministrationPage, ISearchPage
    {
        ...
        public void BindGrid(int paramPageIndex, int paramPageSize)
        {
            ...
            if (this.DateTimeId == "本月")
            {

                DateTimeMonth = dt.Month.ToString();//当前月份

            }
            else if (this.DateTimeId == "本季")
            {
            ...
            var CWPlatformSpendingList = base.CWPlatformSpendingService.GetCWPlatformSpendingList(ProjectId, DateTimeYear,DateTimeMonth);
