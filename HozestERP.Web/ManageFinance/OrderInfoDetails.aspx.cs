...
{  
    public partial class OrderInfoDetails : BaseAdministrationPage, ISearchPage
    { 
        ...
        public void BindGrid(int paramPageIndex, int paramPageSize)
        {
           ...
           DateTime dt = Convert.ToDateTime(dt1.ToString("yyyy-MM-dd"));
            ...
            var xmOrderInfoList = base.XMOrderInfoService.getXMOrderInfoList(Convert.ToInt32(this.PlatformTypeId), nickIdList, Convert.ToDateTime(OrderInfoModifiedStart), Convert.ToDateTime(OrderInfoModifiedEnd), Convert.ToInt32(this.OrderStatusId), "");
