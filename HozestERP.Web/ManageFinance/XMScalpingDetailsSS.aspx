<%@  Page  Title="" Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true"
 CodeBehind="XMScalpingDetailsSS.aspx.cs" Inherits="HozestERP.Web.ManageFinance.XMScalpingDetailsSS" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="server"> 
    <asp:GridView ID="grdXMScalpingDetailsList" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
        SkinID="GridViewThemen" OnRowDataBound="grdXMScalpingDetailsList_RowDataBound" 
         ShowFooter="true">
        <Columns>
           ...
           <asp:TemplateField HeaderText="销售价"  SortExpression="SalesPrice">
            <HeaderStyle Width="80px" HorizontalAlign="Center" Wrap="False" />
            <ItemStyle Width="80px" HorizontalAlign="Center" Wrap="False" />
            <ItemTemplate>
                <%# Eval("SalesPrice")%>
