...
{
    public partial class ImportSaleProduct : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        string partpath = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath) + @"\UpLoad\XMSaleDelivery";
                        ...
                        base.ImportManager.ImportSaleDeliveryList(serpath, ref paramMessage, NickId, Begin);
