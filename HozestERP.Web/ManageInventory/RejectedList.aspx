<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true"
    CodeBehind="RejectedList.aspx.cs" Inherits="HozestERP.Web.ManageInventory.RejectedList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:GridView ID="grdvRejected" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="出厂工厂">
                <HeaderStyle Width="65px" HorizontalAlign="Center" Wrap="False" />
                <ItemTemplate>
                    <%# Eval("EmitFactory")%>
                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="退回状态" SortExpression="BillStatus">
                <HeaderStyle Width="65px" HorizontalAlign="Center" Wrap="False" />
                <ItemTemplate>
                    <asp:Literal ID="lblBillStatus" runat="server"></asp:Literal>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="操作">
                ...
                <ItemTemplate>
                    <asp:ImageButton ID="imgProductDetails" runat="server" ImageUrl="~/App_Themes/Blue/Image/ButtonImages/meeting.gif"
                        ToolTip="查看未入库采购退货单" CommandName="look" CausesValidation="False" Visible="<% $CRMIsActionAllowed:ManageInventory.RejectedList.ProductDetails %>" />
                    <asp:ImageButton ID="imgBtnEdit" runat="server" ImageUrl="~/App_Themes/Default/Image/update.gif"
                        ToolTip="编辑未入库采购退货单" CommandName="Edit" CausesValidation="False" Visible="<% $CRMIsActionAllowed:ManageInventory.RejectedList.Edit %>" />
                    <asp:ImageButton ID="imgBtnDelete" runat="server" ImageUrl="~/App_Themes/Default/Image/close02.gif"
                        ...
                        Visible="<% $CRMIsActionAllowed:ManageInventory.RejectedList.Delete %>" OnClientClick="return confirm('您确定要删除此条记录？');" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
...
<asp:Content ID="Content5" ContentPlaceHolderID="Contentplaceholder3" runat="server">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td>
                <asp:Button ID="btnIsReturn" SkinID="button4" runat="server" Text="完成退回" OnClick="btnIsReturn_Click"
                    Visible="<% $CRMIsActionAllowed:ManageInventory.RejectedList.IsReturn %>" />
            </td>
            <td style="width: 4px">
            </td>
            <td>
                <asp:Button ID="btnConcelIsReturn" SkinID="button4" runat="server" Text="撤销退回" OnClick="btnConcelIsReturn_Click"
                    Visible="<% $CRMIsActionAllowed:ManageInventory.RejectedList.ConcelIsReturn %>" />
            </td>
            <td style="width: 4px">
            </td>
            <td>
                <asp:Button ID="btnImportData" SkinID="button4" runat="server" Text="退货单导出" OnClick="btnImportData_Click"
                    Visible="<% $CRMIsActionAllowed:ManageInventory.RejectedList.ImportData %>" />
            </td>
        </tr>
    </table>
</asp:Content>
