...
{
    public partial class ImportJDSelfSupport : BaseAdministrationPage, IEditPage
    {
            ...
            try
            {
                ...
                if (DataFilePath.HasFile)
                {
                    ...
                    if (typ == "xls" || typ == "xlsx")
                    {
                        ...
                        string partpath = HttpContext.Current.Server.MapPath(HttpContext.Current.Request.ApplicationPath) + @"\UpLoad\ImportJDSelfSupport";
                        ...
                        base.ImportManager.ImportJDSelfSupportFromXls(serpath, ref paramMessage);
