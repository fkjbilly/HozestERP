...
namespace vipapis.marketplace.inventory{
	...
	public class SkuStockHelper : TBeanSerializer<SkuStock>
	{
		
		public static SkuStockHelper OBJ = new SkuStockHelper();
		
		public static SkuStockHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(SkuStock structs, Protocol iprot){
		...
		public void Write(SkuStock structs, Protocol oprot){
		...
		public void Validate(SkuStock bean){
