...
namespace vipapis.marketplace.inventory{
	...
	public class StoreSkuStockHelper : TBeanSerializer<StoreSkuStock>
	{
		
		public static StoreSkuStockHelper OBJ = new StoreSkuStockHelper();
		
		public static StoreSkuStockHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(StoreSkuStock structs, Protocol iprot){
		...
		public void Write(StoreSkuStock structs, Protocol oprot){
		...
		public void Validate(StoreSkuStock bean){
