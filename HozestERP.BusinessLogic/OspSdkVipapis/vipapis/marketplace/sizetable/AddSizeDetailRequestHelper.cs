...
namespace vipapis.marketplace.sizetable{
	...
	public class AddSizeDetailRequestHelper : TBeanSerializer<AddSizeDetailRequest>
	{
		
		public static AddSizeDetailRequestHelper OBJ = new AddSizeDetailRequestHelper();
		...
		public void Read(AddSizeDetailRequest structs, Protocol iprot){
		...
		public void Write(AddSizeDetailRequest structs, Protocol oprot){
		...
		public void Validate(AddSizeDetailRequest bean){
