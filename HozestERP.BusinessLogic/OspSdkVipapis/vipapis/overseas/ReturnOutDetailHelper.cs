...
namespace vipapis.overseas{
	...
	public class ReturnOutDetailHelper : TBeanSerializer<ReturnOutDetail>
	{
		
		public static ReturnOutDetailHelper OBJ = new ReturnOutDetailHelper();
		...
		public void Read(ReturnOutDetail structs, Protocol iprot){
		...
		public void Write(ReturnOutDetail structs, Protocol oprot){
		...
		public void Validate(ReturnOutDetail bean){
