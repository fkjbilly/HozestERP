...
namespace vipapis.overseas{
	...
	public class OrderOutDetailHelper : TBeanSerializer<OrderOutDetail>
	{
		
		public static OrderOutDetailHelper OBJ = new OrderOutDetailHelper();
		
		public static OrderOutDetailHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(OrderOutDetail structs, Protocol iprot){
		...
		public void Write(OrderOutDetail structs, Protocol oprot){
		...
		public void Validate(OrderOutDetail bean){
