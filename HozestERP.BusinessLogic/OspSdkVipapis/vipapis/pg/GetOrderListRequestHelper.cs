...
namespace vipapis.pg{
	...
	public class GetOrderListRequestHelper : TBeanSerializer<GetOrderListRequest>
	{
		
		public static GetOrderListRequestHelper OBJ = new GetOrderListRequestHelper();
		...
		public void Read(GetOrderListRequest structs, Protocol iprot){
		...
		public void Write(GetOrderListRequest structs, Protocol oprot){
		...
		public void Validate(GetOrderListRequest bean){
