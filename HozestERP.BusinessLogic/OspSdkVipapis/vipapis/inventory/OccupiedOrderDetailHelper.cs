...
namespace vipapis.inventory{
	...
	public class OccupiedOrderDetailHelper : TBeanSerializer<OccupiedOrderDetail>
	{
		...
		public void Read(OccupiedOrderDetail structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("cooperation_mode".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetCooperation_mode(value);
					}
		...
		public void Write(OccupiedOrderDetail structs, Protocol oprot){
			...
			if(structs.GetCooperation_mode() != null) {
				
				oprot.WriteFieldBegin("cooperation_mode");
				oprot.WriteString(structs.GetCooperation_mode());
