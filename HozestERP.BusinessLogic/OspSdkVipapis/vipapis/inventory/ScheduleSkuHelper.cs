...
namespace vipapis.inventory{
	...
	public class ScheduleSkuHelper : TBeanSerializer<ScheduleSku>
	{
		
		public static ScheduleSkuHelper OBJ = new ScheduleSkuHelper();
		...
		public void Read(ScheduleSku structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("latest_update_time".Equals(schemeField.Trim())){
						
						needSkip = false;
						long? value;
						value = iprot.ReadI64(); 
						
						structs.SetLatest_update_time(value);
					}
		...
		public void Write(ScheduleSku structs, Protocol oprot){
			...
			if(structs.GetSelling_status() != null) {
				...
				oprot.WriteI32((int)structs.GetSelling_status()); 
			...
			if(structs.GetLatest_update_time() != null) {
				
				oprot.WriteFieldBegin("latest_update_time");
				oprot.WriteI64((long)structs.GetLatest_update_time()); 
		...
		public void Validate(ScheduleSku bean){
