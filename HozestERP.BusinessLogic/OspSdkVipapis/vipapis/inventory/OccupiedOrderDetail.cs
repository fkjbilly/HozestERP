...
namespace vipapis.inventory{
	...
	public class OccupiedOrderDetail {
		...
		///<summary>
		/// 合作模式（目前返回dvd/jit/jit_4a)
		///</summary>
		
		private string cooperation_mode_;
		...
		public string GetCooperation_mode(){
			return this.cooperation_mode_;
		}
		
		public void SetCooperation_mode(string value){
			this.cooperation_mode_ = value;
		}
