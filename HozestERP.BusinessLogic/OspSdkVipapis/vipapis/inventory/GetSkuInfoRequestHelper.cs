...
namespace vipapis.inventory{
	...
	public class GetSkuInfoRequestHelper : TBeanSerializer<GetSkuInfoRequest>
	{
		
		public static GetSkuInfoRequestHelper OBJ = new GetSkuInfoRequestHelper();
		...
		public void Read(GetSkuInfoRequest structs, Protocol iprot){
		...
		public void Write(GetSkuInfoRequest structs, Protocol oprot){
		...
		public void Validate(GetSkuInfoRequest bean){
