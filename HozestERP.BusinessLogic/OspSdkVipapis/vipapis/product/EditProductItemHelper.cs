...
namespace vipapis.product{
	...
	public class EditProductItemHelper : TBeanSerializer<EditProductItem>
	{
		
		public static EditProductItemHelper OBJ = new EditProductItemHelper();
		...
		public void Read(EditProductItem structs, Protocol iprot){
		...
		public void Write(EditProductItem structs, Protocol oprot){
		...
		public void Validate(EditProductItem bean){
