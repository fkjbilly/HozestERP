...
namespace vipapis.product{
	...
	public class CreateSkuItemHelper : TBeanSerializer<CreateSkuItem>
	{
		
		public static CreateSkuItemHelper OBJ = new CreateSkuItemHelper();
		...
		public void Read(CreateSkuItem structs, Protocol iprot){
		...
		public void Write(CreateSkuItem structs, Protocol oprot){
		...
		public void Validate(CreateSkuItem bean){
