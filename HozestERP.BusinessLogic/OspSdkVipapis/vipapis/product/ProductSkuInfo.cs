...
namespace vipapis.product{
	...
	public class ProductSkuInfo {
		...
		///<summary>
		/// 销售属性
		/// @sampleValue flat_sale_props 格式：pid:vid； 143:114，134:666666~孔雀蓝
		///</summary>
		...
		///<summary>
		/// 图片列表,spu级别
		/// @sampleValue spu_image_list 
		///</summary>
		
		private List<vipapis.product.ProductImage> spu_image_list_;
		
		///<summary>
		/// 颜色图片列表，sku级别，针对同款色商品
		...
		public List<vipapis.product.ProductImage> GetSpu_image_list(){
			return this.spu_image_list_;
		}
		
		public void SetSpu_image_list(List<vipapis.product.ProductImage> value){
			this.spu_image_list_ = value;
		}
