...
namespace vipapis.normal{
	...
	public class SellableUpdateInventoryRequest {
		...
		private List<vipapis.normal.SellableProductInventory> sellableProductInventoryList_;
		...
		public List<vipapis.normal.SellableProductInventory> GetSellableProductInventoryList(){
			return this.sellableProductInventoryList_;
		}
		
		public void SetSellableProductInventoryList(List<vipapis.normal.SellableProductInventory> value){
			this.sellableProductInventoryList_ = value;
		}
