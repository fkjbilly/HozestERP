...
namespace vipapis.normal{
	...
	public class InventoryUpdateResultRequestHelper : TBeanSerializer<InventoryUpdateResultRequest>
	{
		
		public static InventoryUpdateResultRequestHelper OBJ = new InventoryUpdateResultRequestHelper();
		...
		public void Read(InventoryUpdateResultRequest structs, Protocol iprot){
		...
		public void Write(InventoryUpdateResultRequest structs, Protocol oprot){
		...
		public void Validate(InventoryUpdateResultRequest bean){
