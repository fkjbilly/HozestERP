...
namespace vipapis.normal{
	...
	public class InventoryUpdateResultHelper : TBeanSerializer<InventoryUpdateResult>
	{
		
		public static InventoryUpdateResultHelper OBJ = new InventoryUpdateResultHelper();
		...
		public void Read(InventoryUpdateResult structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("stock_mode".Equals(schemeField.Trim())){
						
						needSkip = false;
						int? value;
						value = iprot.ReadI32(); 
						
						structs.SetStock_mode(value);
					}
		...
		public void Write(InventoryUpdateResult structs, Protocol oprot){
			...
			if(structs.GetModify_time() != null) {
				...
				oprot.WriteI64((long)structs.GetModify_time()); 
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetStock_mode() != null) {
				
				oprot.WriteFieldBegin("stock_mode");
				oprot.WriteI32((int)structs.GetStock_mode()); 
		...
		public void Validate(InventoryUpdateResult bean){
