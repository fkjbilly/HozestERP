...
namespace vipapis.order{
	...
	public class OxoOrderRequestHelper : TBeanSerializer<OxoOrderRequest>
	{
		
		public static OxoOrderRequestHelper OBJ = new OxoOrderRequestHelper();
		
		public static OxoOrderRequestHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(OxoOrderRequest structs, Protocol iprot){
		...
		public void Write(OxoOrderRequest structs, Protocol oprot){
		...
		public void Validate(OxoOrderRequest bean){
