...
namespace vipapis.order{
	...
	public class PushOrderPackageWeightRespHelper : TBeanSerializer<PushOrderPackageWeightResp>
	{
		
		public static PushOrderPackageWeightRespHelper OBJ = new PushOrderPackageWeightRespHelper();
		...
		public void Read(PushOrderPackageWeightResp structs, Protocol iprot){
		...
		public void Write(PushOrderPackageWeightResp structs, Protocol oprot){
		...
		public void Validate(PushOrderPackageWeightResp bean){
