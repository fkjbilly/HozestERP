...
namespace vipapis.order{
	...
	public class UpdateStoreSnRespHelper : TBeanSerializer<UpdateStoreSnResp>
	{
		
		public static UpdateStoreSnRespHelper OBJ = new UpdateStoreSnRespHelper();
		
		public static UpdateStoreSnRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(UpdateStoreSnResp structs, Protocol iprot){
		...
		public void Write(UpdateStoreSnResp structs, Protocol oprot){
		...
		public void Validate(UpdateStoreSnResp bean){
