...
namespace vipapis.vipcard{
	...
	public class ActivateCodeInfoHelper : TBeanSerializer<ActivateCodeInfo>
	{
		
		public static ActivateCodeInfoHelper OBJ = new ActivateCodeInfoHelper();
		
		public static ActivateCodeInfoHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(ActivateCodeInfo structs, Protocol iprot){
		...
		public void Write(ActivateCodeInfo structs, Protocol oprot){
			...
			if(structs.GetActivate_code() != null) {
				...
				throw new ArgumentException("activate_code can not be null!");
			}
		...
		public void Validate(ActivateCodeInfo bean){
