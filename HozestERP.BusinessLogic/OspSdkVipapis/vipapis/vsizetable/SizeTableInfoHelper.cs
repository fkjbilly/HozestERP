...
namespace vipapis.vsizetable{
	...
	public class SizeTableInfoHelper : TBeanSerializer<SizeTableInfo>
	{
		
		public static SizeTableInfoHelper OBJ = new SizeTableInfoHelper();
		
		public static SizeTableInfoHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(SizeTableInfo structs, Protocol iprot){
		...
		public void Write(SizeTableInfo structs, Protocol oprot){
		...
		public void Validate(SizeTableInfo bean){
