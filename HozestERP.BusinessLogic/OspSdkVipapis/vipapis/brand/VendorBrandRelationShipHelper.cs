...
namespace vipapis.brand{
	...
	public class VendorBrandRelationShipHelper : TBeanSerializer<VendorBrandRelationShip>
	{
		
		public static VendorBrandRelationShipHelper OBJ = new VendorBrandRelationShipHelper();
		
		public static VendorBrandRelationShipHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(VendorBrandRelationShip structs, Protocol iprot){
		...
		public void Write(VendorBrandRelationShip structs, Protocol oprot){
		...
		public void Validate(VendorBrandRelationShip bean){
