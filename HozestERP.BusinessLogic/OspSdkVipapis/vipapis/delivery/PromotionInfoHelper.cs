...
namespace vipapis.delivery{
	...
	public class PromotionInfoHelper : TBeanSerializer<PromotionInfo>
	{
		
		public static PromotionInfoHelper OBJ = new PromotionInfoHelper();
		...
		public void Read(PromotionInfo structs, Protocol iprot){
		...
		public void Write(PromotionInfo structs, Protocol oprot){
		...
		public void Validate(PromotionInfo bean){
