...
namespace vipapis.delivery{
	...
	public class GetCarrierListResponseHelper : TBeanSerializer<GetCarrierListResponse>
	{
					...
					if ("carriers".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.delivery.Carrier elem0;
								
								elem0 = new vipapis.delivery.Carrier();
								vipapis.delivery.CarrierHelper.getInstance().Read(elem0, iprot);
