...
namespace vipapis.delivery{
	...
	public class ConfirmReturnOrderRequestHelper : TBeanSerializer<ConfirmReturnOrderRequest>
	{
		
		public static ConfirmReturnOrderRequestHelper OBJ = new ConfirmReturnOrderRequestHelper();
		...
		public void Read(ConfirmReturnOrderRequest structs, Protocol iprot){
		...
		public void Write(ConfirmReturnOrderRequest structs, Protocol oprot){
		...
		public void Validate(ConfirmReturnOrderRequest bean){
