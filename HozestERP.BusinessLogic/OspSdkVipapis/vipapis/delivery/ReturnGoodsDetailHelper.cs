...
namespace vipapis.delivery{
	...
	public class ReturnGoodsDetailHelper : TBeanSerializer<ReturnGoodsDetail>
	{
		
		public static ReturnGoodsDetailHelper OBJ = new ReturnGoodsDetailHelper();
		...
		public void Read(ReturnGoodsDetail structs, Protocol iprot){
		...
		public void Write(ReturnGoodsDetail structs, Protocol oprot){
		...
		public void Validate(ReturnGoodsDetail bean){
