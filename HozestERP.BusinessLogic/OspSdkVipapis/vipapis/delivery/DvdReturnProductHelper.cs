...
namespace vipapis.delivery{
	...
	public class DvdReturnProductHelper : TBeanSerializer<DvdReturnProduct>
	{
		
		public static DvdReturnProductHelper OBJ = new DvdReturnProductHelper();
		...
		public void Read(DvdReturnProduct structs, Protocol iprot){
		...
		public void Write(DvdReturnProduct structs, Protocol oprot){
		...
		public void Validate(DvdReturnProduct bean){
