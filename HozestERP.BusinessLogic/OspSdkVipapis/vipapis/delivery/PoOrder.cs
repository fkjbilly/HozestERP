...
namespace vipapis.delivery{
	...
	public class PoOrder {
		...
		/// @sampleValue po_start_time 2016-06-22 11:23:52
		///</summary>
		...
		public int? GetNormality_flag(){
			return this.normality_flag_;
		}
		
		public void SetNormality_flag(int? value){
			this.normality_flag_ = value;
		}
