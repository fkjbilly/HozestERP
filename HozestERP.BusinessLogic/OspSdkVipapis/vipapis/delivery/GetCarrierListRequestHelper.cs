...
namespace vipapis.delivery{
	...
	public class GetCarrierListRequestHelper : TBeanSerializer<GetCarrierListRequest>
	{
		
		public static GetCarrierListRequestHelper OBJ = new GetCarrierListRequestHelper();
		...
		public void Read(GetCarrierListRequest structs, Protocol iprot){
		...
		public void Write(GetCarrierListRequest structs, Protocol oprot){
		...
		public void Validate(GetCarrierListRequest bean){
