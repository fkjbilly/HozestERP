...
namespace vipapis.delivery{
	...
	public class ConfirmRefuseResultRequest {
		...
		private List<vipapis.delivery.RefuseGoods> goods_list_;
		...
		public List<vipapis.delivery.RefuseGoods> GetGoods_list(){
			return this.goods_list_;
		}
		
		public void SetGoods_list(List<vipapis.delivery.RefuseGoods> value){
