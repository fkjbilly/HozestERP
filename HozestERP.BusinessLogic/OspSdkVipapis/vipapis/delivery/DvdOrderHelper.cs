...
namespace vipapis.delivery{
	...
	public class DvdOrderHelper : TBeanSerializer<DvdOrder>
	{
		...
		public void Read(DvdOrder structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("vis_add_time".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetVis_add_time(value);
					}
		...
		public void Write(DvdOrder structs, Protocol oprot){
			...
			if(structs.GetVis_add_time() != null) {
				
				oprot.WriteFieldBegin("vis_add_time");
				oprot.WriteString(structs.GetVis_add_time());
