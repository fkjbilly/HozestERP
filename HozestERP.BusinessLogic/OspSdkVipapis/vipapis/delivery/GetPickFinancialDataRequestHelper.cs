...
namespace vipapis.delivery{
	...
	public class GetPickFinancialDataRequestHelper : TBeanSerializer<GetPickFinancialDataRequest>
	{
		
		public static GetPickFinancialDataRequestHelper OBJ = new GetPickFinancialDataRequestHelper();
		...
		public void Read(GetPickFinancialDataRequest structs, Protocol iprot){
		...
		public void Write(GetPickFinancialDataRequest structs, Protocol oprot){
		...
		public void Validate(GetPickFinancialDataRequest bean){
