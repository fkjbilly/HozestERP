...
namespace vipapis.delivery{
	...
	public class PoOrderHelper : TBeanSerializer<PoOrder>
	{
		
		public static PoOrderHelper OBJ = new PoOrderHelper();
		...
		public void Read(PoOrder structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("normality_flag".Equals(schemeField.Trim())){
						
						needSkip = false;
						int? value;
						value = iprot.ReadI32(); 
						
						structs.SetNormality_flag(value);
					}
		...
		public void Write(PoOrder structs, Protocol oprot){
			...
			if(structs.GetNormality_flag() != null) {
				
				oprot.WriteFieldBegin("normality_flag");
				oprot.WriteI32((int)structs.GetNormality_flag()); 
		...
		public void Validate(PoOrder bean){
