...
namespace vipapis.product{
	...
	public class VendorProductSubmitResultHelper : BeanSerializer<VendorProductSubmitResult>
	{
		
		public static VendorProductSubmitResultHelper OBJ = new VendorProductSubmitResultHelper();
		...
		public void Read(VendorProductSubmitResult structs, Protocol iprot){
		...
		public void Write(VendorProductSubmitResult structs, Protocol oprot){
		...
		public void Validate(VendorProductSubmitResult bean){
