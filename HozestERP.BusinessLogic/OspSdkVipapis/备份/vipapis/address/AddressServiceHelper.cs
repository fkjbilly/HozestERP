...
namespace vipapis.address{
	...
	public class AddressServiceHelper {
		...
		public class getFullAddress_argsHelper : BeanSerializer<getFullAddress_args>
		{
		...
		public class getProvinceWarehouse_argsHelper : BeanSerializer<getProvinceWarehouse_args>
		{
		...
		public class getFullAddress_resultHelper : BeanSerializer<getFullAddress_result>
		{
		...
		public class getProvinceWarehouse_resultHelper : BeanSerializer<getProvinceWarehouse_result>
		{
