...
namespace vipapis.vreturn{
	...
	public class VendorReturnServiceHelper {
		...
		public class getReturnDetail_argsHelper : BeanSerializer<getReturnDetail_args>
		{
		...
		public class getReturnInfo_argsHelper : BeanSerializer<getReturnInfo_args>
		{
		...
		public class getReturnDetail_resultHelper : BeanSerializer<getReturnDetail_result>
		{
		...
		public class getReturnInfo_resultHelper : BeanSerializer<getReturnInfo_result>
		{
