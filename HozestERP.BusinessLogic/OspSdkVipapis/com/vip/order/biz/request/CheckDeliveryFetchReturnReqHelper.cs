...
namespace com.vip.order.biz.request{
	...
	public class CheckDeliveryFetchReturnReqHelper : TBeanSerializer<CheckDeliveryFetchReturnReq>
	{
		
		public static CheckDeliveryFetchReturnReqHelper OBJ = new CheckDeliveryFetchReturnReqHelper();
		
		public static CheckDeliveryFetchReturnReqHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CheckDeliveryFetchReturnReq structs, Protocol iprot){
		...
		public void Write(CheckDeliveryFetchReturnReq structs, Protocol oprot){
		...
		public void Validate(CheckDeliveryFetchReturnReq bean){
