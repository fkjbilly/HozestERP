...
namespace com.vip.order.biz.request{
	...
	public class NewGoodsInfoHelper : TBeanSerializer<NewGoodsInfo>
	{
		
		public static NewGoodsInfoHelper OBJ = new NewGoodsInfoHelper();
		
		public static NewGoodsInfoHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(NewGoodsInfo structs, Protocol iprot){
		...
		public void Write(NewGoodsInfo structs, Protocol oprot){
		...
		public void Validate(NewGoodsInfo bean){
