...
namespace com.vip.order.biz.response{
	...
	public class GetLimitedOrderGoodsCountRespHelper : TBeanSerializer<GetLimitedOrderGoodsCountResp>
	{
		
		public static GetLimitedOrderGoodsCountRespHelper OBJ = new GetLimitedOrderGoodsCountRespHelper();
		
		public static GetLimitedOrderGoodsCountRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(GetLimitedOrderGoodsCountResp structs, Protocol iprot){
		...
		public void Write(GetLimitedOrderGoodsCountResp structs, Protocol oprot){
		...
		public void Validate(GetLimitedOrderGoodsCountResp bean){
