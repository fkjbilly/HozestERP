...
namespace com.vip.order.biz.response{
	...
	public class OrderListCountRespHelper : TBeanSerializer<OrderListCountResp>
	{
		
		public static OrderListCountRespHelper OBJ = new OrderListCountRespHelper();
		
		public static OrderListCountRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(OrderListCountResp structs, Protocol iprot){
		...
		public void Write(OrderListCountResp structs, Protocol oprot){
		...
		public void Validate(OrderListCountResp bean){
