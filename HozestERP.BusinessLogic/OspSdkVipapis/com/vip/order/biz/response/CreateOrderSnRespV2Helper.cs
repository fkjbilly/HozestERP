...
namespace com.vip.order.biz.response{
	...
	public class CreateOrderSnRespV2Helper : TBeanSerializer<CreateOrderSnRespV2>
	{
		
		public static CreateOrderSnRespV2Helper OBJ = new CreateOrderSnRespV2Helper();
		
		public static CreateOrderSnRespV2Helper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CreateOrderSnRespV2 structs, Protocol iprot){
		...
		public void Write(CreateOrderSnRespV2 structs, Protocol oprot){
		...
		public void Validate(CreateOrderSnRespV2 bean){
