...
namespace com.vip.order.biz.response{
	...
	public class SearchOrderListRespHelper : TBeanSerializer<SearchOrderListResp>
	{
		
		public static SearchOrderListRespHelper OBJ = new SearchOrderListRespHelper();
		
		public static SearchOrderListRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(SearchOrderListResp structs, Protocol iprot){
		...
		public void Write(SearchOrderListResp structs, Protocol oprot){
		...
		public void Validate(SearchOrderListResp bean){
