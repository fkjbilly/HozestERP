...
namespace com.vip.order.biz.response{
	...
	public class GetCanRefundOrderCountRespHelper : TBeanSerializer<GetCanRefundOrderCountResp>
	{
		
		public static GetCanRefundOrderCountRespHelper OBJ = new GetCanRefundOrderCountRespHelper();
		
		public static GetCanRefundOrderCountRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(GetCanRefundOrderCountResp structs, Protocol iprot){
		...
		public void Write(GetCanRefundOrderCountResp structs, Protocol oprot){
		...
		public void Validate(GetCanRefundOrderCountResp bean){
