...
namespace com.vip.order.biz.response{
	...
	public class BatchGetOrderTransportListRespHelper : TBeanSerializer<BatchGetOrderTransportListResp>
	{
		
		public static BatchGetOrderTransportListRespHelper OBJ = new BatchGetOrderTransportListRespHelper();
		
		public static BatchGetOrderTransportListRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(BatchGetOrderTransportListResp structs, Protocol iprot){
		...
		public void Write(BatchGetOrderTransportListResp structs, Protocol oprot){
		...
		public void Validate(BatchGetOrderTransportListResp bean){
