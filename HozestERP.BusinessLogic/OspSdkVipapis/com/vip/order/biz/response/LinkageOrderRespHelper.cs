...
namespace com.vip.order.biz.response{
	...
	public class LinkageOrderRespHelper : TBeanSerializer<LinkageOrderResp>
	{
		
		public static LinkageOrderRespHelper OBJ = new LinkageOrderRespHelper();
		
		public static LinkageOrderRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(LinkageOrderResp structs, Protocol iprot){
		...
		public void Write(LinkageOrderResp structs, Protocol oprot){
		...
		public void Validate(LinkageOrderResp bean){
