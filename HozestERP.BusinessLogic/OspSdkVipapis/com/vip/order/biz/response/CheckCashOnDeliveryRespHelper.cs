...
namespace com.vip.order.biz.response{
	...
	public class CheckCashOnDeliveryRespHelper : TBeanSerializer<CheckCashOnDeliveryResp>
	{
		
		public static CheckCashOnDeliveryRespHelper OBJ = new CheckCashOnDeliveryRespHelper();
		
		public static CheckCashOnDeliveryRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CheckCashOnDeliveryResp structs, Protocol iprot){
		...
		public void Write(CheckCashOnDeliveryResp structs, Protocol oprot){
		...
		public void Validate(CheckCashOnDeliveryResp bean){
