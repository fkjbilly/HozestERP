...
namespace com.vip.order.common.pojo.order.vo{
	...
	public class OrderVOHelper : TBeanSerializer<OrderVO>
	{
		...
		public void Read(OrderVO structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("deliveryManId".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetDeliveryManId(value);
					}
					...
					if ("compensateFlag".Equals(schemeField.Trim())){
						
						needSkip = false;
						int? value;
						value = iprot.ReadI32(); 
						
						structs.SetCompensateFlag(value);
					}
					...
					if ("carriageDetail".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetCarriageDetail(value);
					}
					...
					if ("reserveStatus".Equals(schemeField.Trim())){
						
						needSkip = false;
						int? value;
						value = iprot.ReadI32(); 
						
						structs.SetReserveStatus(value);
					}
					...
					if ("deviceKey".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetDeviceKey(value);
					}
		...
		public void Write(OrderVO structs, Protocol oprot){
			...
			if(structs.GetDeliveryManId() != null) {
				
				oprot.WriteFieldBegin("deliveryManId");
				oprot.WriteString(structs.GetDeliveryManId());
			...
			if(structs.GetCompensateFlag() != null) {
				
				oprot.WriteFieldBegin("compensateFlag");
				oprot.WriteI32((int)structs.GetCompensateFlag()); 
			...
			if(structs.GetDeliveryPromisedTime() != null) {
				...
				oprot.WriteI64((long)structs.GetDeliveryPromisedTime()); 
			...
			if(structs.GetCarriageDetail() != null) {
				
				oprot.WriteFieldBegin("carriageDetail");
				oprot.WriteString(structs.GetCarriageDetail());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetReserveStatus() != null) {
				
				oprot.WriteFieldBegin("reserveStatus");
				oprot.WriteI32((int)structs.GetReserveStatus()); 
			...
			if(structs.GetStoreSource() != null) {
				...
				oprot.WriteI32((int)structs.GetStoreSource()); 
			...
			if(structs.GetDeviceKey() != null) {
				
				oprot.WriteFieldBegin("deviceKey");
				oprot.WriteString(structs.GetDeviceKey());
