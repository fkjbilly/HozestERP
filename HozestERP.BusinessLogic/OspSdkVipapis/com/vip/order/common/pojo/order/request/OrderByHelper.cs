			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("direction".Equals(schemeField.Trim())){
						...
						needSkip = false;
						com.vip.order.common.pojo.order.request.OrderByDirection? value;
						
						value = com.vip.order.common.pojo.order.request.OrderByDirectionUtil.FindByName(iprot.ReadString());
