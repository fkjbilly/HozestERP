...
namespace com.vip.haitao.loading.osp.service{
	...
	public class FailOrdersHelper : TBeanSerializer<FailOrders>
	{
		
		public static FailOrdersHelper OBJ = new FailOrdersHelper();
		...
		public void Read(FailOrders structs, Protocol iprot){
		...
		public void Write(FailOrders structs, Protocol oprot){
		...
		public void Validate(FailOrders bean){
