...
namespace com.vip.haitao.orderservice.service{
	...
	public class HtSaleOrderResultModelHelper : TBeanSerializer<HtSaleOrderResultModel>
	{
		
		public static HtSaleOrderResultModelHelper OBJ = new HtSaleOrderResultModelHelper();
		...
		public void Read(HtSaleOrderResultModel structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("HtSaleOrderInfoVopModelList".Equals(schemeField.Trim())){
						...
						needSkip = false;
						List<com.vip.haitao.orderservice.service.HtSaleOrderInfoModel> value;
						
						value = new List<com.vip.haitao.orderservice.service.HtSaleOrderInfoModel>();
						iprot.ReadListBegin();
						while(true){
							
							try{
								
								com.vip.haitao.orderservice.service.HtSaleOrderInfoModel elem1;
								
								elem1 = new com.vip.haitao.orderservice.service.HtSaleOrderInfoModel();
								com.vip.haitao.orderservice.service.HtSaleOrderInfoModelHelper.getInstance().Read(elem1, iprot);
		...
		public void Write(HtSaleOrderResultModel structs, Protocol oprot){
			...
			if(structs.GetHtSaleOrderInfoVopModelList() != null) {
				...
				foreach(com.vip.haitao.orderservice.service.HtSaleOrderInfoModel _item0 in structs.GetHtSaleOrderInfoVopModelList()){
					
					
					com.vip.haitao.orderservice.service.HtSaleOrderInfoModelHelper.getInstance().Write(_item0, oprot);
			...
			if(structs.GetOrderDeliveryBatch() != null) {
				...
				throw new ArgumentException("orderDeliveryBatch can not be null!");
			}
		...
		public void Validate(HtSaleOrderResultModel bean){
