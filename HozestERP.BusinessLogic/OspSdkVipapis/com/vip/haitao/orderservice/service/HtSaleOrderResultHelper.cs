...
namespace com.vip.haitao.orderservice.service{
	...
	public class HtSaleOrderResultHelper : TBeanSerializer<HtSaleOrderResult>
	{
		
		public static HtSaleOrderResultHelper OBJ = new HtSaleOrderResultHelper();
		...
		public void Read(HtSaleOrderResult structs, Protocol iprot){
					...
					if ("HtSaleOrderInfoVopModelList".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								com.vip.haitao.orderservice.service.HtSaleOrderInfoModel elem0;
								
								elem0 = new com.vip.haitao.orderservice.service.HtSaleOrderInfoModel();
								com.vip.haitao.orderservice.service.HtSaleOrderInfoModelHelper.getInstance().Read(elem0, iprot);
		...
		public void Write(HtSaleOrderResult structs, Protocol oprot){
		...
		public void Validate(HtSaleOrderResult bean){
