...
namespace com.vip.haitao.orderservice.service{
	...
	public class HtSaleOrderChbResultModel {
		...
		///<summary>
		/// 是否需要打包作业[当档期销售模式为13,则为1,其余则为0]
		///</summary>
		
		private int? isPackage_;
		
		///<summary>
		/// 申报海关类型，总署/地方关 1-总署；2-地方关
		///</summary>
		
		private int? declareType_;
		
		///<summary>
		/// 收货人证件类型
		///</summary>
		
		private int? buyerIdtype_;
		...
		private int? payerIdtype_;
		
		///<summary>
		/// 订购人证件号码
		///</summary>
		
		private string payerIdnumber_;
		
		///<summary>
		/// 订购人电话,海关监控对象的电话
		///</summary>
		
		private string payerTelephone_;
		...
		private List<com.vip.haitao.orderservice.service.HtSaleOrderInfoChbModel> HtSaleOrderInfoVopModelList_;
		...
		public void SetIsPackage(int? value){
			this.isPackage_ = value;
		}
		public int? GetDeclareType(){
			return this.declareType_;
		}
		
		public void SetDeclareType(int? value){
			this.declareType_ = value;
		}
		public int? GetBuyerIdtype(){
			return this.buyerIdtype_;
		}
		
		public void SetBuyerIdtype(int? value){
			this.buyerIdtype_ = value;
		}
		...
		public void SetPayerName(string value){
			this.payerName_ = value;
		}
		public int? GetPayerIdtype(){
			return this.payerIdtype_;
		}
		
		public void SetPayerIdtype(int? value){
			this.payerIdtype_ = value;
		}
		public string GetPayerIdnumber(){
			return this.payerIdnumber_;
		}
		
		public void SetPayerIdnumber(string value){
			this.payerIdnumber_ = value;
		}
		public string GetPayerTelephone(){
			return this.payerTelephone_;
		}
		
		public void SetPayerTelephone(string value){
			this.payerTelephone_ = value;
		}
		...
		public List<com.vip.haitao.orderservice.service.HtSaleOrderInfoChbModel> GetHtSaleOrderInfoVopModelList(){
			return this.HtSaleOrderInfoVopModelList_;
		}
		
		public void SetHtSaleOrderInfoVopModelList(List<com.vip.haitao.orderservice.service.HtSaleOrderInfoChbModel> value){
