...
namespace com.vip.haitao.orderservice.service{
	...
	public class HtSaleOrderChbResultHelper : TBeanSerializer<HtSaleOrderChbResult>
	{
		
		public static HtSaleOrderChbResultHelper OBJ = new HtSaleOrderChbResultHelper();
		...
		public void Read(HtSaleOrderChbResult structs, Protocol iprot){
					...
					if ("HtSaleOrderInfoVopModelList".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								com.vip.haitao.orderservice.service.HtSaleOrderInfoChbModel elem0;
								
								elem0 = new com.vip.haitao.orderservice.service.HtSaleOrderInfoChbModel();
								com.vip.haitao.orderservice.service.HtSaleOrderInfoChbModelHelper.getInstance().Read(elem0, iprot);
		...
		public void Write(HtSaleOrderChbResult structs, Protocol oprot){
		...
		public void Validate(HtSaleOrderChbResult bean){
