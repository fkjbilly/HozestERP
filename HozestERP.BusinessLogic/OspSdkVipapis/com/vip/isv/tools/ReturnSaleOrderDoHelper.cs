...
namespace com.vip.isv.tools{
	...
	public class ReturnSaleOrderDoHelper : TBeanSerializer<ReturnSaleOrderDo>
	{
		
		public static ReturnSaleOrderDoHelper OBJ = new ReturnSaleOrderDoHelper();
		
		public static ReturnSaleOrderDoHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(ReturnSaleOrderDo structs, Protocol iprot){
		...
		public void Write(ReturnSaleOrderDo structs, Protocol oprot){
		...
		public void Validate(ReturnSaleOrderDo bean){
