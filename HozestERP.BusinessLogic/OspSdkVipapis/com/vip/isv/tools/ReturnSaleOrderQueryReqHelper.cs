...
namespace com.vip.isv.tools{
	...
	public class ReturnSaleOrderQueryReqHelper : TBeanSerializer<ReturnSaleOrderQueryReq>
	{
		
		public static ReturnSaleOrderQueryReqHelper OBJ = new ReturnSaleOrderQueryReqHelper();
		
		public static ReturnSaleOrderQueryReqHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(ReturnSaleOrderQueryReq structs, Protocol iprot){
		...
		public void Write(ReturnSaleOrderQueryReq structs, Protocol oprot){
		...
		public void Validate(ReturnSaleOrderQueryReq bean){
