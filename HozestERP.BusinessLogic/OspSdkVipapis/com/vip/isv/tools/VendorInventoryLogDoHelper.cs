...
namespace com.vip.isv.tools{
	...
	public class VendorInventoryLogDoHelper : TBeanSerializer<VendorInventoryLogDo>
	{
		
		public static VendorInventoryLogDoHelper OBJ = new VendorInventoryLogDoHelper();
		
		public static VendorInventoryLogDoHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(VendorInventoryLogDo structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("isIncremental".Equals(schemeField.Trim())){
						
						needSkip = false;
						int? value;
						value = iprot.ReadI32(); 
						
						structs.SetIsIncremental(value);
					}
		...
		public void Write(VendorInventoryLogDo structs, Protocol oprot){
			...
			if(structs.GetIsIncremental() != null) {
				
				oprot.WriteFieldBegin("isIncremental");
				oprot.WriteI32((int)structs.GetIsIncremental()); 
		...
		public void Validate(VendorInventoryLogDo bean){
