...
namespace com.vip.isv.tools{
	...
	public class InventoryApplyDetailQueryReqHelper : TBeanSerializer<InventoryApplyDetailQueryReq>
	{
		
		public static InventoryApplyDetailQueryReqHelper OBJ = new InventoryApplyDetailQueryReqHelper();
		
		public static InventoryApplyDetailQueryReqHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(InventoryApplyDetailQueryReq structs, Protocol iprot){
		...
		public void Write(InventoryApplyDetailQueryReq structs, Protocol oprot){
		...
		public void Validate(InventoryApplyDetailQueryReq bean){
