...
namespace com.vip.isv.tools{
	...
	public class SkuSaleCountInfoQueryReqHelper : TBeanSerializer<SkuSaleCountInfoQueryReq>
	{
		
		public static SkuSaleCountInfoQueryReqHelper OBJ = new SkuSaleCountInfoQueryReqHelper();
		
		public static SkuSaleCountInfoQueryReqHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(SkuSaleCountInfoQueryReq structs, Protocol iprot){
		...
		public void Write(SkuSaleCountInfoQueryReq structs, Protocol oprot){
		...
		public void Validate(SkuSaleCountInfoQueryReq bean){
