...
namespace com.vip.isv.schema{
	...
	public class CreateProductBySchemaRequestHelper : TBeanSerializer<CreateProductBySchemaRequest>
	{
		
		public static CreateProductBySchemaRequestHelper OBJ = new CreateProductBySchemaRequestHelper();
		
		public static CreateProductBySchemaRequestHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CreateProductBySchemaRequest structs, Protocol iprot){
		...
		public void Write(CreateProductBySchemaRequest structs, Protocol oprot){
		...
		public void Validate(CreateProductBySchemaRequest bean){
