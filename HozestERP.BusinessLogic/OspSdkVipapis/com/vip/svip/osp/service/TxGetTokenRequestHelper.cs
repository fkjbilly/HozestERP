...
namespace com.vip.svip.osp.service{
	...
	public class TxGetTokenRequestHelper : TBeanSerializer<TxGetTokenRequest>
	{
		
		public static TxGetTokenRequestHelper OBJ = new TxGetTokenRequestHelper();
		...
		public void Read(TxGetTokenRequest structs, Protocol iprot){
		...
		public void Write(TxGetTokenRequest structs, Protocol oprot){
		...
		public void Validate(TxGetTokenRequest bean){
