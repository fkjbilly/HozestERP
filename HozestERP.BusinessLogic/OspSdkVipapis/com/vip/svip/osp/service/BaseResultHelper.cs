...
namespace com.vip.svip.osp.service{
	...
	public class BaseResultHelper : TBeanSerializer<BaseResult>
	{
		
		public static BaseResultHelper OBJ = new BaseResultHelper();
		
		public static BaseResultHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(BaseResult structs, Protocol iprot){
		...
		public void Write(BaseResult structs, Protocol oprot){
		...
		public void Validate(BaseResult bean){
