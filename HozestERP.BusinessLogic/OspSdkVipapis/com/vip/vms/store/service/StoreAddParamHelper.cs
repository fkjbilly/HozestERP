...
namespace com.vip.vms.store.service{
	...
	public class StoreAddParamHelper : TBeanSerializer<StoreAddParam>
	{
		
		public static StoreAddParamHelper OBJ = new StoreAddParamHelper();
		...
		public void Read(StoreAddParam structs, Protocol iprot){
		...
		public void Write(StoreAddParam structs, Protocol oprot){
		...
		public void Validate(StoreAddParam bean){
