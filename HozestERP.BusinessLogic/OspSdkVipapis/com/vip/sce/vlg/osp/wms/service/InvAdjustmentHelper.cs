...
namespace com.vip.sce.vlg.osp.wms.service{
	...
	public class InvAdjustmentHelper : TBeanSerializer<InvAdjustment>
	{
		
		public static InvAdjustmentHelper OBJ = new InvAdjustmentHelper();
		...
		public void Read(InvAdjustment structs, Protocol iprot){
		...
		public void Write(InvAdjustment structs, Protocol oprot){
		...
		public void Validate(InvAdjustment bean){
