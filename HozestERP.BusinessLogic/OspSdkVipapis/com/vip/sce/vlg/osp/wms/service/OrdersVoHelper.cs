...
namespace com.vip.sce.vlg.osp.wms.service{
	...
	public class OrdersVoHelper : TBeanSerializer<OrdersVo>
	{
		
		public static OrdersVoHelper OBJ = new OrdersVoHelper();
		...
		public void Read(OrdersVo structs, Protocol iprot){
		...
		public void Write(OrdersVo structs, Protocol oprot){
		...
		public void Validate(OrdersVo bean){
