...
namespace com.vip.sce.vlg.osp.wms.service{
	...
	public class PostHeaderHelper : TBeanSerializer<PostHeader>
	{
		
		public static PostHeaderHelper OBJ = new PostHeaderHelper();
		
		public static PostHeaderHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(PostHeader structs, Protocol iprot){
		...
		public void Write(PostHeader structs, Protocol oprot){
		...
		public void Validate(PostHeader bean){
