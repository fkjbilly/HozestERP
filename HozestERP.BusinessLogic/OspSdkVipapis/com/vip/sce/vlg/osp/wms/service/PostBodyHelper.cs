	...
	public class PostBodyHelper : TBeanSerializer<PostBody>
	{
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("returnErrorList".Equals(schemeField.Trim())){
						...
						needSkip = false;
						List<com.vip.sce.vlg.osp.wms.service.PostReturnError> value;
						
						value = new List<com.vip.sce.vlg.osp.wms.service.PostReturnError>();
						iprot.ReadListBegin();
						while(true){
							
							try{
								
								com.vip.sce.vlg.osp.wms.service.PostReturnError elem1;
								
								elem1 = new com.vip.sce.vlg.osp.wms.service.PostReturnError();
								com.vip.sce.vlg.osp.wms.service.PostReturnErrorHelper.getInstance().Read(elem1, iprot);
		...
		public void Write(PostBody structs, Protocol oprot){
			...
			if(structs.GetReturnErrorList() != null) {
				...
				oprot.WriteListBegin();
				foreach(com.vip.sce.vlg.osp.wms.service.PostReturnError _item0 in structs.GetReturnErrorList()){
					
					
					com.vip.sce.vlg.osp.wms.service.PostReturnErrorHelper.getInstance().Write(_item0, oprot);
