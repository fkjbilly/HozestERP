...
namespace com.vip.domain.inventory{
	...
	public class EditPoRequestHelper : TBeanSerializer<EditPoRequest>
	{
		
		public static EditPoRequestHelper OBJ = new EditPoRequestHelper();
		...
		public void Read(EditPoRequest structs, Protocol iprot){
		...
		public void Write(EditPoRequest structs, Protocol oprot){
		...
		public void Validate(EditPoRequest bean){
