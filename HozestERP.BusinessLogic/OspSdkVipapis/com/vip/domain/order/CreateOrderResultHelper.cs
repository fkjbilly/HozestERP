...
namespace com.vip.domain.order{
	...
	public class CreateOrderResultHelper : TBeanSerializer<CreateOrderResult>
	{
		
		public static CreateOrderResultHelper OBJ = new CreateOrderResultHelper();
		
		public static CreateOrderResultHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CreateOrderResult structs, Protocol iprot){
		...
		public void Write(CreateOrderResult structs, Protocol oprot){
		...
		public void Validate(CreateOrderResult bean){
