...
namespace com.vip.domain.order{
	...
	public class CreateCustomerBackOrderResultHelper : TBeanSerializer<CreateCustomerBackOrderResult>
	{
		
		public static CreateCustomerBackOrderResultHelper OBJ = new CreateCustomerBackOrderResultHelper();
		...
		public void Read(CreateCustomerBackOrderResult structs, Protocol iprot){
		...
		public void Write(CreateCustomerBackOrderResult structs, Protocol oprot){
		...
		public void Validate(CreateCustomerBackOrderResult bean){
