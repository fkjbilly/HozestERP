...
namespace com.vip.vop.vcloud.jit{
	...
	public class DeleteDeliveryDetailRequestHelper : TBeanSerializer<DeleteDeliveryDetailRequest>
	{
		
		public static DeleteDeliveryDetailRequestHelper OBJ = new DeleteDeliveryDetailRequestHelper();
		
		public static DeleteDeliveryDetailRequestHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(DeleteDeliveryDetailRequest structs, Protocol iprot){
		...
		public void Write(DeleteDeliveryDetailRequest structs, Protocol oprot){
		...
		public void Validate(DeleteDeliveryDetailRequest bean){
