...
namespace com.vip.vop.vcloud.jit{
	...
	public class GetDeliveryDetailRequestHelper : TBeanSerializer<GetDeliveryDetailRequest>
	{
		
		public static GetDeliveryDetailRequestHelper OBJ = new GetDeliveryDetailRequestHelper();
		
		public static GetDeliveryDetailRequestHelper getInstance() {
		...
		public void Write(GetDeliveryDetailRequest structs, Protocol oprot){
		...
		public void Validate(GetDeliveryDetailRequest bean){
