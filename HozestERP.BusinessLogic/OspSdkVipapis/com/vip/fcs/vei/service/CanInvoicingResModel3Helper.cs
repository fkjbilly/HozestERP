...
namespace com.vip.fcs.vei.service{
	...
	public class CanInvoicingResModel3Helper : TBeanSerializer<CanInvoicingResModel3>
	{
		
		public static CanInvoicingResModel3Helper OBJ = new CanInvoicingResModel3Helper();
		
		public static CanInvoicingResModel3Helper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CanInvoicingResModel3 structs, Protocol iprot){
		...
		public void Write(CanInvoicingResModel3 structs, Protocol oprot){
		...
		public void Validate(CanInvoicingResModel3 bean){
