...
namespace HozestERP.BusinessLogic.Enterprises
{
    public partial interface ILogisticsAgingService
    {
        ...
        void TimingGetLogisticsAging();

        /// <summary>
        /// get to LogisticsAging list
        /// </summary>
        List<LogisticsAging> GetLogisticsAgingList();
        List<LogisticsAging> GetLogisticsAgingListByParam(string DepartureCity, string DestinationCity, string Pathway);
