...
namespace HozestERP.BusinessLogic.Enterprises
{
    public partial interface IProvinceWarehouseSpareService
    {
        ...
        List<ProvinceWarehouseSpare> GetProvinceWarehouseSpareByProvinceWarehouseID(int ProvinceWarehouseID);

        List<ProvinceWarehouseSpare> GetProvinceWarehouseSpareByParm(int ProvinceWarehouseID, int Sequence, int SpareWarehouse);
