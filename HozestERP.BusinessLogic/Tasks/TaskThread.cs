...
namespace HozestERP.BusinessLogic.Tasks
{
    ...
    public partial class TaskThread : IDisposable
    {
        ...
        internal TaskThread(XmlNode node)
        {
            ...
            //    if (node.Attributes["name"].Value == "DCKeywordRankTaskThread")
            //    {
            //        int intervalMinutes = IoC.Resolve<ISettingManager>().GetSettingValueInteger("TopTaobaoRankIntervalMinutes");
            //        this._seconds = intervalMinutes * 60;
            //    }
            //}
        }
