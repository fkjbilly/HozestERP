...
namespace HozestERP.BusinessLogic.Tasks
{
    ...
    public partial class Task
    {
        ...
        public Task(Type taskType, XmlNode configNode)
        {
            ...
            {
                bool.TryParse(configNode.Attributes["enabled"].Value, out this._enabled);
            }
            if (configNode.Attributes["stopOnError"] != null)
            {
                bool.TryParse(configNode.Attributes["stopOnError"].Value, out this._stopOnError);
            }
