...
namespace HozestERP.BusinessLogic.ManageInventory
{
    public partial class XMAllocateProductDetailsService : IXMAllocateProductDetailsService
    {
        ...
        /// <summary>
        /// get to XMAllocateProductDetails list  by  AllcateId
        /// </summary>
        /// <param name="allcateId"></param>
        /// <returns></returns>
        public List<XMAllocateProductDetails> GetXMAllocateProductDetailsListByAllcateId(int allcateId)
        {
            var query = from p in this._context.XMAllocateProductDetails
                        where p.IsEnable == false && p.AllocateId == allcateId
                        select p;
            return query.ToList();
        }
        /// <summary>
