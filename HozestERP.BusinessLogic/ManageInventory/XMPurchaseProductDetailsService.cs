...
namespace HozestERP.BusinessLogic.ManageInventory
{
    public partial class XMPurchaseProductDetailsService : IXMPurchaseProductDetailsService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<XMPurchaseProductDetails> GetXMPurchaseProductDetailsByPurchaseID(int purchaseID)
        {
            var query = from p in this._context.XMPurchaseProductDetails
        ...
        /// <returns></returns>
        public List<XMPurchaseProductDetails> GetXMPurchaseProductDetailsByDateTime(DateTime StartDate, DateTime EndDate, string PlatformMerchantCode)
        {
            var query = from p in this._context.XMPurchaseProductDetails
                        join t in this._context.XMPurchases
                         on p.PurchaseId equals t.Id
                        where p.IsEnable == false
        ...
        /// <param name="platformMerchantCode"></param>
        /// <returns></returns>
        public List<XMPurchaseProductDetails> GetXMPurchaseProductDetailsByPurchaseIDAndPlatformMerchantCode(int purchaseID, string platformMerchantCode)
        {
            var query = from p in this._context.XMPurchaseProductDetails
                        where p.IsEnable == false
                      && p.PurchaseId == purchaseID
