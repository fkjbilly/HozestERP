...
namespace HozestERP.BusinessLogic.ManageInventory
{
    public partial interface IXMSaleDeliveryBarCodeDetailService
    {
        ...
        /// <returns></returns>
        List<XMSaleDeliveryBarCodeDetail> GetXMSaleDeliveryBarCodeDetailListBySpdID(int spdId);
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <param name="spdID"></param>
        /// <returns></returns>
        List<XMSaleDeliveryBarCodeDetail> GetXMSaleDeliveryBarCodeDetailListByParm(string barCode, int spdID);
        ...
        /// <param name="barCode"></param>
        /// <returns></returns>
        XMSaleDeliveryBarCodeDetail GetXMSaleDeliveryBarCodeDetailByParm(int spdId, string barCode);
        /// <summary>
