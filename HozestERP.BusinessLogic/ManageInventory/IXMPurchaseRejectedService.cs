...
namespace HozestERP.BusinessLogic.ManageInventory
{
    public partial interface IXMPurchaseRejectedService
    {
        ...
        /// <returns></returns>
        List<XMPurchaseRejected> GetXMPurchaseRejectedListByParm(string rejectedCode, string productName, string begin, string end, int supplierId, int status, string customerids, bool isStorage);
        /// <summary>
        /// 更具采购单ID 查询未入库退货单列表
        /// </summary>
        /// <param name="purchaseID"></param>
        /// <returns></returns>
        List<XMPurchaseRejected> GetXMPurchaseRejectedListByPurchaseID(int purchaseID);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="refNumber"></param>
        /// <returns></returns>
        XMPurchaseRejected GetXMPurchaseRejectedsByRef(string refNumber);
        /// <summary>
        /// 根据入库单ID 查询已入库退货单记录
        /// </summary>
        /// <param name="storageID"></param>
        /// <returns></returns>
        List<XMPurchaseRejected> GetXMPurchaseRejectedListByStorageID(int storageID);
