...
namespace HozestERP.BusinessLogic.ManageInventory
{
    public partial interface IXMJDRealTimeInventoryService
    {
        ...
        /// </summary>
        /// <returns></returns>
        List<XMJDRealTimeInventory> GetXMJDRealTimeInventoryListByParm(string platformCode, string productName, string nickids, int wareHoursesID, int projectId, string nickids2);
        ...
        /// <returns></returns>
        XMJDRealTimeInventory GetXMJDRealTimeInventoryParm(string platformMerchantCode, int wfId);
