...
namespace HozestERP.BusinessLogic.ExportImport
{
    public class ExcelBE
    {
        ...
        private bool _bold = false;//是否加粗
        private bool _horizontalAlignment = false;//是否水平居中
        ...
        public ExcelBE(int row, int col, string text, string startCell, string endCell, string interiorColor, bool isMerge,
            int size, string fontColor, string format, bool bold, bool horizontalAlignment)
        {
            _row = row;
            _col = col;
            _text = text;
