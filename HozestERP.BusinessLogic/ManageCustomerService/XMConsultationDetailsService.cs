...
namespace HozestERP.BusinessLogic.ManageCustomerService
{
    public partial class XMConsultationDetailsService: IXMConsultationDetailsService
    {
        ...
        /// <param name="id">XMConsultationDetails id</param>
        /// <returns>XMConsultationDetails</returns>   
        public List<XMConsultationDetails> GetXMConsultationDetailsByClist(int id)
        {
            var query = from p in this._context.XMConsultationDetails
                        where p.ConsultationId == id
                        orderby p.ContactTime ascending
                        select p;
        ...
        /// <param name="id">XMConsultationDetails id</param>
        /// <returns>XMConsultationDetails</returns>   
        public XMConsultationDetails GetXMConsultationDetailsByConid(int id)
        {
            var query = from p in this._context.XMConsultationDetails
                        where p.ConsultationId==id
                        orderby p.ContactTime descending
                        select p;
        ...
        /// <param name="id">XMConsultationDetails id</param>
        /// <returns>XMConsultationDetails</returns>   
        public int GetXMConsultationDetailsCount(int id)
        {
            var query = from p in this._context.XMConsultationDetails
                        where p.ConsultationId == id
                        select p;
