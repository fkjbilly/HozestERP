...
namespace HozestERP.BusinessLogic.ManageCustomerService
{
    public partial interface IXMCustomerWangNoService
    {
        ...
        XMWangNo GetXMCustomerWangNoName(int WangNoID);
        ...
        List<XMCustomerWangNo> GetXMCustomerWangNoByCustomerID(int CustomerID);
        List<XMCustomerWangNo> GetXMCustomerWangNoByWangNoID(int WangNoID);
