...
namespace HozestERP.BusinessLogic.ManageBusiness
{
    public partial interface IXMOtherCostDetailService
    {
        ...
        /// <returns></returns>
        XMOtherCostDetail GetXMOtherCostDataByParm(int id, int departmentID, int year);

        List<XMOtherCostDetail> GetXMOtherCostDataAudit(int id, int departmentID, int year);
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        List<XMOtherCostDetail> GetXMOtherCostDataByParm(int departmentID, int year);

        List<XMOtherCostDetail> GetXMOtherCostDataByParm2(int departmentID, int year);
