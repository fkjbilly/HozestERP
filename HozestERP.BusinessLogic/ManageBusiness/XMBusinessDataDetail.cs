...
namespace HozestERP.BusinessLogic.ManageBusiness
{
    public partial class XMBusinessDataDetail : BaseEntity
    {
        ...
        public string B2CBusinessTypeName
        {
            get
            {
                if (this.B2CBusinessType != null)
                {
                    return IoC.Resolve<ICodeService>().GetCodeListInfoByCodeID((int)this.B2CBusinessType).CodeName;
                }
                else
                {
                    return "";
