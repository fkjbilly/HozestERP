...
{
    public partial class GetIntegrationMyContract_Result: BaseEntity
    {
    	...
    	/// <summary>
        /// Gets or sets the OperationCommissionerID
        /// </summary>
    	public Nullable<int> OperationCommissionerID{ get; set; } 
    	
    	/// <summary>
        /// Gets or sets the CustomerManagerID
        /// </summary>
    	public Nullable<int> CustomerManagerID{ get; set; } 
    	
    	/// <summary>
        /// Gets or sets the CopywriterCommissionerID
        /// </summary>
    	public Nullable<int> CopywriterCommissionerID{ get; set; } 
    	
    	/// <summary>
        /// Gets or sets the OperationCommissioner
        /// </summary>
    	public string OperationCommissioner{ get; set; } 
    	
    	/// <summary>
        /// Gets or sets the CustomerManager
        /// </summary>
    	public string CustomerManager{ get; set; } 
    	
    	/// <summary>
        /// Gets or sets the CopywriterCommissioner
        /// </summary>
    	public string CopywriterCommissioner{ get; set; } 
