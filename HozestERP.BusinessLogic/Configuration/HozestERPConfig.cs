...
namespace HozestERP.BusinessLogic.Configuration
{
    /// <summary>
    /// Represents a HozestERPConfig
    /// </summary>
    public partial class HozestERPConfig : IConfigurationSectionHandler
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes the HozestERPConfig object
        /// </summary>
        public static void Init()
        {
            if (!_initialized)
            {
                ConfigurationManager.GetSection("HozestERPConfig");
                _initialized = true;
            }
        }
        #endregion
