...
namespace HozestERP.BusinessLogic.ManageProject
{
    public partial interface IXMGiftStorageRecordService
    {
        ...
        List<XMGiftStorageRecord> GetXMGiftStorageRecordListByParm();
        List<XMGiftStorageRecord> GetXMGiftStorageRecordListByDate(DateTime Begin, DateTime End);

        XMProduct GetProductInfo(int ProductId);
        List<XMProduct> GetXMProductListByCode(string ProductCode);
