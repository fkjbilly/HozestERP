...
namespace HozestERP.BusinessLogic.ManageProject
{
    public partial class XMProductCombinationService: IXMProductCombinationService
    {
        ...
        public List<XMProductCombination> GetXMProductCombinationByCombinationID(int CombinationID)
        {
            var query = from p in this._context.XMProductCombinations
                        where p.IsEnabled==false
                        && p.CombinationID == CombinationID
                        select p;
            return query.ToList();
        }
        ...
        public XMProductCombination GetXMProductCombinationByIDCom(int CombinationID, int ProductID)
        {
            var query = from p in this._context.XMProductCombinations
                        where p.CombinationID == CombinationID
