    ...
    public partial class XMClaimInfoProductDetails : BaseEntity
    {
        ...
        public string ManufacturersCode
        {
            get
            {
                ...
                {
                    var Product = IoC.Resolve<IXMProductService>().getXMProductListByPlatformMerchantCode(this.PlatformMerchantCode);
                    if (Product != null && Product.Count > 0)
                    {
                        value = Product[0].ManufacturersCode;
                    }
                }
                return value;
            }
