...
namespace HozestERP.BusinessLogic.ManageProject
{
    public partial interface IXMOrderInfoOperatingRecordService
    {
        ...
        List<XMOrderInfoOperatingRecord> GetXMOrderInfoOperatingRecordListByParm(int OrderInfoId, string PropertyName, string OldValue, string NewValue);
        ...
        PagedList<XMOrderInfoOperatingRecord> SearchXMOrderInfoOperatingRecord(int OrderInfoId, string PropertyName, int pageIndex, int pageSize, string sortExpression, string sortDirection);
        #endregion
    }
}
