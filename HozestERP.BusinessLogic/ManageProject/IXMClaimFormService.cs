...
namespace HozestERP.BusinessLogic.ManageProject
{
    public partial interface IXMClaimFormService
    {
        ...
        List<XMClaimForm> GetXMClaimFormListByCondition(int Platform, int nickid, string ClaimNumber, int Financial, int ClaimType, string ApplicationNo, string OrderCode, DateTime BeginDate, DateTime EndDate);
    	List<XMClaimForm> GetXMClaimFormListByApplicationNo(string ApplicationNo);
