...
namespace HozestERP.BusinessLogic.Audit
{
    ...
    public partial interface ICustomerActivityService
    {
        ...
        /// <param name="commentParams">The activity comment parameters for string.Format() function.</param>
        /// <returns>Activity log item</returns>
        ActivityLog InsertActivity(int merchantID, string systemKeyword, string comment, params object[] commentParams);
        ...
        /// <param name="pageSize">Page size</param>
        /// <returns>Activity log collection</returns>
        PagedList<ActivityLog> GetAllActivitiesByMerchantID(int merchantID, string systemKeyword, int pageIndex, int pageSize);
